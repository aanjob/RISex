...
#End Region
    ...
    Private Sub FRekTrmBB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLRekTrmBB", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@Tahun", SqlDbType.Int).Value = MainModule.periodeTahun
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "RekTrmBB")
        Try
            DsLapF.Tables("RekTrmBB").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "RekTrmBB")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "RekTrmBB"
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Rekap Penerimaan Bahan")
        If fileName <> "" Then
