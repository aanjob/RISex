...
#End Region
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLArusHutSupp", koneksi)
        ...
        cmsl.TableMappings.Add("Table", "ArusHut")
        Try
            DsLapF.Tables("ArusHut").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "ArusHut")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "ArusHut"
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Arus Hutang Supplier Per Tanggal " & Format(System.DateTime.Now, "dd-MM-yy") & "")
        If fileName <> "" Then
