...
#End Region
    ...
    Private Sub FUmurHut_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        ...
        cmsl = New SqlDataAdapter("SPLUmurHut", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@Tanggal", SqlDbType.Date).Value = Me.DTPTanggal.EditValue
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "SPLUmurHut")
        Try
            DsLapF.Tables("SPLUmurHut").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "SPLUmurHut")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "SPLUmurHut"
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Umur Hutang Supplier")
        If fileName <> "" Then
