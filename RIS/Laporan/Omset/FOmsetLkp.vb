...
#End Region
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        ...
        If Gol <> "Lain-Lain" Then
            cmsl = New SqlDataAdapter("SPLOmsetLkp", koneksi)
            ...
            cmsl.SelectCommand.Parameters.Add("@NilRp", SqlDbType.VarChar).Value = Me.CENilTukar.EditValue
        Else
        ...
        cmsl.TableMappings.Add("Table", "OmsetLkp" & Gol)

        Try
            DsLapF.Tables("OmsetLkp" & Gol).Clear()
        Catch ex As Exception

        End Try

        cmsl.Fill(DsLapF, "OmsetLkp" & Gol)

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "OmsetLkp" & Gol
    End Sub
    ...
    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Omset Lengkap " & Gol & " Per Tanggal " & Format(Me.DTPAkhir.EditValue, "dd-MM-yy") & "")
        If fileName <> "" Then
