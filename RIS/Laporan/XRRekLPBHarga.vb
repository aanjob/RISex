...
Public Class XRRekLPBHarga
    ...
    Dim SumGFPropertyQty As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    Dim SumGFPropertyHAkh As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    Dim SumGFPropertyDPP As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    Dim SumGFPropertyPPn As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    ...
    Public Sub InitializeData()
        ...
        Me.LBPeriode.Text = "Periode : " & Format(CDate(MainModule.PilihAwal), "dd MMMM yyyy") & " s/d " & Format(CDate(MainModule.PilihAkhir), "dd MMMM yyyy")
        Me.LBUser.Text = MainModule.LoginAktif

        Me.GHProperty.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LBGHProperty})
        Me.GHProperty.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("Property", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        Me.LBGHProperty.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.Property")})
        ...
        Me.GFSuppID.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LBGFSuppID, Me.LBGFSuppIDQty, Me.LBGFSuppIDHAkh, Me.LBGFSuppIDDPP, Me.LBGFSuppIDPPn, Me.LBGFProperty})
        ...
        Me.GFProperty.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LBGFProperty, Me.LBGFPropertyQty, Me.LBGFPropertyHAkh, Me.LBGFPropertyDPP, Me.LBGFPropertyPPn})

        Me.LBGFProperty.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.Property", "Total {0}")})

        Me.LBGFPropertyQty.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.Qty", "{0:n2}")})
        SumGFPropertyQty.FormatString = "{0:n2}"
        SumGFPropertyQty.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFPropertyQty.Summary = SumGFPropertyQty

        Me.LBGFPropertyHAkh.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.HarAkhir", "{0:n2}")})
        SumGFPropertyHAkh.FormatString = "{0:n2}"
        SumGFPropertyHAkh.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFPropertyHAkh.Summary = SumGFPropertyHAkh

        Me.LBGFPropertyDPP.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.DPP", "{0:n2}")})
        SumGFPropertyDPP.FormatString = "{0:n2}"
        SumGFPropertyDPP.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFPropertyDPP.Summary = SumGFPropertyDPP

        Me.LBGFPropertyPPn.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "RekLPB.PPn", "{0:n2}")})
        SumGFPropertyPPn.FormatString = "{0:n2}"
        SumGFPropertyPPn.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFPropertyPPn.Summary = SumGFPropertyPPn
