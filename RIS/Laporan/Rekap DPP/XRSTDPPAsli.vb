...
Public Class XRSTDPPAsli
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
       ...
       Me.LBUser.Text = MainModule.LoginAktif
        ...
        Me.LBSpreading.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_DPPBJDtl.Jenis")})
