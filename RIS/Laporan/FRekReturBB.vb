...
#End Region
    ...
    Private Sub FRekReturBB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLRekReturBB", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@Tahun", SqlDbType.Int).Value = MainModule.periodeTahun
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "RekReturBB")
        Try
            DsLapF.Tables("RekReturBB").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "RekReturBB")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "RekReturBB"
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Rekap Retur Bahan")
        If fileName <> "" Then
