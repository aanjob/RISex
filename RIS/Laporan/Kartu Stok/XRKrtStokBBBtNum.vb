...
Public Class XRKrtStokBBBtNum
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("SPLKStokBBBtNum", koneksi)
        ...
        cmsl.SelectCommand.Parameters.Add("@BtNum", SqlDbType.VarChar).Value = Bind.Item("BtNum").ToString
        ...
        Me.GHBBID.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("BBIDBtNum", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        Me.LBBtNum.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "StokBB.BtNum", ": {0}")})
