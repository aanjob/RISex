...
#End Region
    ...
    Private Sub FBOMVsLPB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select BOMID,SPK,ArtName,Warna From T_BOM", koneksi)
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLBOMVsLPB", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@BOM", SqlDbType.VarChar).Value = Me.SLUBOMID.EditValue
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "BOMVsLPB")
        Try
            DsLapF.Tables("BOMVsLPB").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "BOMVsLPB")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "BOMVsLPB"
    End Sub


    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "BOM Vs LPB Vs Rtr")
        If fileName <> "" Then
