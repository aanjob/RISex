...
#End Region
    ...
    Private Sub FStokBJHarga_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        ...
        cmsl.SelectCommand.Parameters.Add("@stsHarga", SqlDbType.VarChar).Value = Me.CBOStsHarga.EditValue
        cmsl.SelectCommand.Parameters.Add("@Gol", SqlDbType.VarChar).Value = Gol
        cmsl.SelectCommand.CommandTimeout = 90000
        cmsl.TableMappings.Add("Table", "StokHargaBJ" & Gol)
        Try
            DsLap.Tables("StokHargaBJ" & Gol).Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLap, "StokHargaBJ" & Gol)
        ...
        If CEPrintOut.EditValue = True Then
            Dim bind As New Collection
            bind.Add(Gol, "Gol")

            Dim XR As New XRStokBJ
    ...
    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Lap Stok Barang Jadi " & Gol & " & Harga Per Tanggal " & Format(Me.DTPTanggal.EditValue, "dd-MM-yy") & "")
        If fileName <> "" Then
