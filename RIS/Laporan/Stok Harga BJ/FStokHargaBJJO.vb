...
#End Region
    ...
    Private Sub FStokHargaBJJO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.DTPTanggal.EditValue = System.DateTime.Now
    End Sub

    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLStokHargaBJJO", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@Tgl", SqlDbType.Date).Value = Me.DTPTanggal.EditValue
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "StokHargaBJJO")
        Try
            DsLapF.Tables("StokHargaBJJO").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "StokHargaBJJO")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "StokHargaBJJO"
    End Sub
