...
#End Region
    ...
    Private Sub FStokHargaBJAll_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.DTPTanggal.EditValue = System.DateTime.Now
    End Sub

    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLStokHargaBJAll", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@Tgl", SqlDbType.Date).Value = Me.DTPTanggal.EditValue
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "StokHargaBJAll")
        Try
            DsLapF.Tables("StokHargaBJAll").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "StokHargaBJAll")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "StokHargaBJAll"
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Lap Stok Barang Jadi & Harga Per Tanggal " & Format(Me.DTPTanggal.EditValue, "dd-MM-yy") & "")
        If fileName <> "" Then
