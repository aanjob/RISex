...
#Region "Export Excel"
    ...
    Private Sub ExportTo(ByVal provider As IExportProvider)
        Try
            ...
            Me.FindForm().Refresh()
            Dim link As BaseExportLink = Me.GridView1.CreateExportLink(provider)
...
#End Region
    ...
    Private Sub FListNewCust_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        ...
        cmsl = New SqlDataAdapter("SPLNewCust", koneksi)
        ...
        cmsl.SelectCommand.Parameters.Add("@UserID", SqlDbType.Int).Value = MainModule.UserAktif

        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "NewCust" & Gol)
        Try
            DsLapF.Tables("NewCust" & Gol).Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "NewCust" & Gol)

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "NewCust" & Gol
    End Sub


    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "New Customer")
        If fileName <> "" Then
