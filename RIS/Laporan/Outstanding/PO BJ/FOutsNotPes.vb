...
#End Region
    ...
    Private Sub FOutsNotPes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLOutsNP", koneksi)
        ...
        cmsl.TableMappings.Add("Table", "OutsNP" & Gol)

        Try
            DsLapF.Tables("OutsNP" & Gol).Clear()
        Catch ex As Exception

        End Try

        cmsl.Fill(DsLapF, "OutsNP" & Gol)

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "OutsNP" & Gol
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Outstanding Nota Pesanan " & Gol & " Per Tanggal " & Format(Me.DTPAkhir.EditValue, "dd-MM-yy") & "")
        If fileName <> "" Then
