...
Public Class XROutsPOImp
    ...
    Dim SumInv As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    Dim SumAct As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        ...
        Me.LBGFInv.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "OutsPO.QtyPL", "{0:#,##0.##}")})

        SumInv.FormatString = "{0:n2}"
        SumInv.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFInv.Summary = SumInv

        Me.LBGFAct.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "OutsPO.QtyAct", "{0:#,##0.##}")})

        SumAct.FormatString = "{0:n2}"
        SumAct.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFAct.Summary = SumAct
    ...
    Private Sub XrLabel16_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles XrLabel16.BeforePrint
        Me.XrLabel16.Text = " Inv : " & StartInv & " Hit Inv : " & StartHitInv & " PO : " & StartPO & " Start : " & Start & " Sisa : " & SisaQty
    End Sub
