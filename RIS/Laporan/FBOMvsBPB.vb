...
#End Region
    ...
    Private Sub FBOMvsBPB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select BOMID,SPK,ArtName,Warna From T_BOM", koneksi) ' Where stsLunas='False'
        cmsl.TableMappings.Add("Table", "T_BOML2")
        cmsl.Fill(DsLapF, "T_BOML2")
        DsLapF.Tables("T_BOML2").Clear()
        cmsl.Fill(DsLapF, "T_BOML2")

        Me.SLUBOMID.Properties.DataSource = DsLapF.Tables("T_BOML2")
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLBOMVsBPB", koneksi)
        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@BOM", SqlDbType.VarChar).Value = Me.SLUBOMID.EditValue
        cmsl.SelectCommand.CommandTimeout = 90000

        cmsl.TableMappings.Add("Table", "BOMVsBPB")
        Try
            DsLapF.Tables("BOMVsBPB").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "BOMVsBPB")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "BOMVsBPB"
    End Sub


    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "BOM Vs BPB Vs RPB")
        If fileName <> "" Then
    ...
    Private Sub BandedGridView1_RowCellStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles BandedGridView1.RowCellStyle
        Try
            If (e.RowHandle >= 0) Then
                If Me.BandedGridView1.GetRowCellValue(e.RowHandle, "Rn") = 1 Then
