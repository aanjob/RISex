...
#End Region
    ...
    Private Sub FRekDetTrmBB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmsl = New SqlDataAdapter("Select SuppID,Nama As Supp From M_Supp", koneksi)
        cmsl.TableMappings.Add("Table", "M_SuppL2")
        cmsl.Fill(DsLapF, "M_SuppL2")
        DsLapF.Tables("M_SuppL2").Clear()
        cmsl.Fill(DsLapF, "M_SuppL2")
        DsLapF.Tables("M_SuppL2").Rows.Add("%", "Semua")


        Me.SLUSupp.Properties.DataSource = DsLapF.Tables("M_SuppL2")
        Me.SLUSupp.Properties.DisplayMember = "Supp"
        Me.SLUSupp.Properties.ValueMember = "SuppID"
    End Sub

    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select H.SuppID,S.Nama As Supp,H.Tanggal,H.TrmID,H.POID,D.BBID,B.Nama As Bahan,D.Sat,D.Qty From T_TrmBB H Inner Join T_TrmBBDtl D On H.TrmID=D.TrmID Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_BB B On D.BBID=B.BBID Inner Join M_BBJns J On B.JnsID=J.JnsID	Where Tanggal>='" & Me.DTPAwal.EditValue & "' and Tanggal<='" & Me.DTPAkhir.EditValue & "' and H.SuppID Like'" & Me.SLUSupp.EditValue & "' Order By Tanggal Asc,TrmID Asc", koneksi)
    ...
    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Rekap Detail Penerimaan Bahan Qty")
        If fileName <> "" Then
