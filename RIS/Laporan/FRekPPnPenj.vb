...
#End Region
    ...
    Private Sub FRekPPnFt_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub SLUSales_Leave(sender As Object, e As EventArgs) Handles SLUCab.Leave
    ...
    Private Sub BProses_Click(sender As Object, e As EventArgs) Handles BProses.Click
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("SPLRekPPnFt", koneksi)

        cmsl.SelectCommand.CommandType = CommandType.StoredProcedure
        cmsl.SelectCommand.Parameters.Add("@CustID", SqlDbType.VarChar).Value = Me.SLUCust.EditValue
        cmsl.SelectCommand.Parameters.Add("@SalID", SqlDbType.VarChar).Value = Me.SLUCab.EditValue
        ...
        cmsl.TableMappings.Add("Table", "RekPPnFt")
        Try
            DsLapF.Tables("RekPPnFt").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsLapF, "RekPPnFt")

        Me.GridControl1.DataSource = DsLapF
        Me.GridControl1.DataMember = "RekPPnFt"

        'MsgBox(Me.SLUCust.EditValue)
        'MsgBox(Me.SLUCab.EditValue)
        'MsgBox(Gol)
        'MsgBox(Me.DTPAwal.EditValue)
        'MsgBox(Me.DTPAkhir.EditValue)
    End Sub

    Private Sub BExExcel_Click(sender As Object, e As EventArgs) Handles BExExcel.Click
        Dim fileName As String = ShowSaveFileDialog("Microsoft Excel Document", "Microsoft Excel|*.xls", "Rekap PPn Penjualan")
        If fileName <> "" Then
