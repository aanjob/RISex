...
Public Class FSearch
    ...
    Public Sub New(ByVal IsiMaster As String, ByVal Filter1 As String, ByVal Filter2 As String, ByVal Filter3 As String, ByVal Filter4 As Date, Filter5 As String)
        ...
        ElseIf Master = "Skema Komisi" Then
            If IO.File.Exists("SrSkmKomisi.xml") Then
                DsSearch = New System.Data.DataSet
                DsSearch.ReadXml("SrSkmKomisi.xml")
            Else
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select Tahun,Ket From M_ScmKms", koneksi)

                cmsl.TableMappings.Add("Table", "M_ScmKmsSr")
                DsSearch = New System.Data.DataSet
                cmsl.Fill(DsSearch, "M_ScmKmsSr")

                DsSearch.WriteXml("SrSkmKomisi.xml", XmlWriteMode.WriteSchema)
            End If

            Me.GridControl1.DataSource = DsSearch
            Me.GridControl1.DataMember = "M_ScmKmsSr"

            Me.GridView1.Columns("Tahun").Width = 100
            Me.GridView1.Columns("Ket").Width = 200

            Me.GridView1.Columns("Tahun").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
            Me.GridView1.Columns("Ket").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        ...
        ElseIf Master = "ProsesLine" Then
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select Distinct Proses,Line From T_HslProd Order By Proses,Line", koneksi)

            cmsl.TableMappings.Add("Table", "ProsesLine")
            DsSearch = New System.Data.DataSet
            cmsl.Fill(DsSearch, "ProsesLine")

            DsSearch.WriteXml("SrProsesLine.xml", XmlWriteMode.WriteSchema)

            Me.GridControl1.DataSource = DsSearch
            Me.GridControl1.DataMember = "ProsesLine"

            Me.GridView1.Columns("Proses").Width = 100

            Me.GridView1.Columns("Proses").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
            Me.GridView1.Columns("Line").OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        ...
        ElseIf Master = "Bahan Stok Harga" Then
            'Filter1=SuppID
            'Filter2=JnsPers
            'Filter3=
            'Filter4=Tanggal

            If IO.File.Exists("SrBBStokH" & Filter2 & ".xml") Then
                DsSearch = New System.Data.DataSet
                DsSearch.ReadXml("SrBBStokH" & Filter2 & ".xml")
            Else
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select * From (Select Distinct B.BBID,B.Nama As Bahan,Uk,B.Sat,(Select Isnull((Select Top 1 (HargaBeli*NilTukarRp)+HargaBahan From M_BBHarga Where BBID=B.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc,HargaIDD desc),0)) As Harga,(Select Isnull((Select Sum(Masuk)-Sum(Keluar) From T_StokBB where BBID=B.BBID and Tanggal<='" & Filter4 & "'),0)) As Stok From M_BB B Inner Join M_BBJns J On B.JnsID=J.JnsID Left Outer Join M_SuppBB S On B.BBID=S.BBID Where S.SuppID Like '" & Filter1 & "' and J.Gol Like'" & Filter2 & "%' and B.Aktif='True') as x Where Stok>0 Order By Bahan", koneksi)

                cmsl.TableMappings.Add("Table", "SrBBStokH" & Filter2)
                DsSearch = New System.Data.DataSet
                cmsl.Fill(DsSearch, "SrBBStokH" & Filter2)

                DsSearch.WriteXml("SrBBStokH" & Filter2 & ".xml", XmlWriteMode.WriteSchema)
            End If

            Me.GridControl1.DataSource = DsSearch
            Me.GridControl1.DataMember = "SrBBStokH" & Filter2
        ...
        ElseIf Master = "Purchase Request Sparepart" Then
            ...
            Else
                ...
                cmsl = New SqlDataAdapter("Select * From (Select H.PRSMID,PRSMIDD,Tanggal,D.BBID,Case When D.Ket='' Then B.Nama Else B.Nama +' ('+ D.Ket +')' End As Bahan,Qty-BtlOrder-(Select Isnull((Select Sum(Qty) From T_POBBDtl Where BOMID=H.PRSMID and DocIDD=D.PRSMIDD),0)) as Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID='" & Filter1 & "' and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,'False' as stsJasa,D.Sat From T_PRSpM H Inner Join T_PRSpMDtl D On H.PRSMID=D.PRSMID Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where Tipe='" & Filter2 & "' and Jenis='" & Filter3 & "' and S.SuppID='" & Filter1 & "') as x Where Qty>0", koneksi)
        ...
        ElseIf Master = "BOM" Then
            ...
            Else
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select * From(Select Distinct H.BOMID,MerkID,JnsID,H.ArtName,Warna,TotPsg+TotPsgPol As TotPsg From T_BOM H Inner Join T_BOMPO P On H.BOMID=P.BOMID Inner join M_Brg Br On P.ArtCode=Br.ArtCode Where stsApp='True' and stsLunas='False' and stsBatal='False' and stsBtlProd='False' Union All Select Distinct H.TambahanID As BOMID,MerkID,JnsID, BH.ArtName,Warna,TotPsg+TotPsgPol As TotPsg From T_BOMTam H Inner Join T_BOMPO P On H.BOMID=P.BOMID Inner join M_Brg Br On P.ArtCode=Br.ArtCode Inner Join T_BOM BH On H.BOMID=BH.BOMID Where H.stsApp='True' and stsLunas='False' and stsBatal='False' and stsBtlProd='False' Union All Select Distinct D.MemoID,MerkID,JnsID,BH.ArtName,Warna,TotPsg+TotPsgPol As TotPsg From T_Memo H Inner Join T_MemoDtl D On H.MemoID=D.MemoID Inner Join T_BOMPO P On D.BOMID=P.BOMID Inner join M_Brg Br On P.ArtCode=Br.ArtCode Inner Join T_BOM BH On D.BOMID=BH.BOMID Where H.stsApp='True' and stsLunas='False' and stsBatal='False' and stsBtlProd='False') as x Order By BOMID", koneksi)
        ...
        ElseIf Master = "BB With Request" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select D.BBID,B.Nama As Bahan,D.Sat,Sum(Req)-(Select Isnull((Select Sum(Qty)-Sum(BtlOrder) From T_POBBDtl Where BOMID=D.ReqPID and BBID=D.BBID and POID<>'" & Filter2 & "'),0)) As Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,D.stsJasa From T_ReqPDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where ReqPID='" & Filter1 & "' and S.SuppID='" & Filter3 & "' And S.Aktif='True' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,ReqPID,SuppID,D.stsJasa Order By Bahan", koneksi)
        ...
        ElseIf Master = "BB Kanan With BOM" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select D.BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0) As Qty,D.stsJasa From T_BOMDtl D Inner Join M_BB B On D.BBID=B.BBID Where BOMID='" & Filter1 & "' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,BOMID,D.stsJasa Union All Select D.BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0) As Qty,D.stsJasa From T_BOMTamDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where TambahanID='" & Filter1 & "' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,TambahanID,D.stsJasa Union All Select D.BBIDTj,B.Nama As Bahan,D.SatTj,Round(Sum(KebTj),0) As Qty,'False' As stsJasa From T_MemoDtl D Inner Join M_BB B On D.BBIDTj=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where MemoID='" & Filter1 & "' and B.Aktif='True' Group By D.BBIDTj,B.Nama,D.SatTj,MemoID", koneksi)
        ...
        ElseIf Master = "BB No BOM" Then
            ...
            If IO.File.Exists("SrBBNBOM" & Filter2 & ".xml") Then
                System.IO.File.Delete("SrBBNBOM" & Filter2 & ".xml")
            End If

            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select Distinct B.BBID,B.Nama As Bahan,Uk,B.Sat,(Select Isnull((Select Top 1 (HargaBeli*NilTukarRp)+HargaBahan From M_BBHarga Where BBID=B.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc,HargaIDD desc),0)) As Harga,stsJasa From M_BB B Inner Join M_BBJns J On B.JnsID=J.JnsID Inner Join M_SuppBB S On B.BBID=S.BBID Where S.SuppID Like '" & Filter1 & "' and J.Gol Like'" & Filter2 & "%' and B.Aktif='True' Order By B.Nama", koneksi)
        ...
        ElseIf Master = "BB BOM BtNum" Then
            ...
            If IO.File.Exists("SrBBBOMBtNum" & Filter1 & ".xml") Then
                System.IO.File.Delete("SrBBBOMBtNum" & Filter1 & ".xml")
            End If

            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select * From(Select '" & Filter5 & "'+BBID As BBID,BtNum As BatchNum,Bahan,Sat,Case When Qty>Stok Then Stok Else Qty End As Qty From (Select x.*,tbl.BtNum, tbl.Stok From (Select BOMID,D.BBID as BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.BOMID and BBID=D.BBID and H.BPBID<>'" & Filter2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.BOMID and BBID=D.BBID),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.BOMID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty From T_BOMDtl D Inner Join M_BB B On D.BBID=B.BBID Where BOMID='" & Filter1 & "' and B.Aktif='True' Group By BOMID,D.BBID,B.Nama,D.Sat) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & Filter3 & "' and Tanggal<='" & Filter4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID Union All Select x.*,tbl.BtNum, tbl.Stok From (Select TambahanID,D.BBID as BBID,B.Nama As Bahan,D.Sat, Round(Sum(Keb)+Sum(Pol),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.TambahanID and BBID=D.BBID and H.BPBID<>'" & Filter2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.TambahanID and BBID=D.BBID),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.TambahanID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty From T_BOMTamDtl D Inner Join M_BB B On D.BBID=B.BBID Where TambahanID='" & Filter1 & "' and B.Aktif='True' Group By TambahanID,D.BBID,B.Nama,D.Sat) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & Filter3 & "' and Tanggal<='" & Filter4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID Union All Select x.*,tbl.BtNum, tbl.Stok From (Select D.MemoID,D.BBIDTj as BBID,B.Nama As Bahan,D.SatTj,Round(Sum(KebTj),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.MemoID and BBID=D.BBIDTj and H.BPBID<>'" & Filter2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.MemoID and BBID=D.BBIDTj),0)) As Qty From T_Memo MH Inner Join T_MemoDtl D On MH.MemoID=D.MemoID Inner Join M_BB B On D.BBIDTj=B.BBID Where D.MemoID='" & Filter1 & "' and B.Aktif='True' and stsApp='True' Group By D.MemoID,D.BBIDTj,B.Nama,D.SatTj) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & Filter3 & "' and Tanggal<='" & Filter4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID) as y)as w Where Qty>0 Order By BBID", koneksi)
            ...
            DsSearch.WriteXml("SrBBBOMBtNum" & Filter1 & ".xml", XmlWriteMode.WriteSchema)
        ...
        ElseIf Master = "LPB" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select POID,TrmID,Tanggal,GdID,DiscP,DiscRp,DiscRpSat From T_TrmBB Where SuppID='" & Filter1 & "' and TipePPn='" & Filter2 & "' and PersenPPn=" & Filter5 & " and MtUang='" & Filter3 & "' and Tanggal<='" & Filter4 & "' and stsTagih='False'", koneksi)
        ...
        ElseIf Master = "ByrPiut Retur" Then
            ...
            Else
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select RtrID As DocID,'Retur' As CaraBayar,'' As Deskripsi,SisaPakai From T_RtrBJ Where CustID in (select CustID FROM M_Cust WHERE Nama=(select dbo.fcCustName('" & Filter1 & "'))) and MtUang='" & Filter3 & "' and stsPakai='False'", koneksi)
    ...
    Private Sub BRefresh_Click(sender As Object, e As EventArgs) Handles BRefresh.Click
        ...
        ElseIf Master = "ProsesLine" Then
            If IO.File.Exists("SrProsesLine.xml") Then
                System.IO.File.Delete("SrProsesLine.xml")
            End If
        ...
        ElseIf Master = "Bahan Stok Harga" Then
            ...
            If IO.File.Exists("SrBBStokH" & F2 & ".xml") Then
                DsSearch = New System.Data.DataSet
                DsSearch.ReadXml("SrBBStokH" & F2 & ".xml")
            Else
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select * From (Select Distinct B.BBID,B.Nama As Bahan,Uk,B.Sat,(Select Isnull((Select Top 1 (HargaBeli*NilTukarRp)+HargaBahan From M_BBHarga Where BBID=B.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc,HargaIDD desc),0)) As Harga,(Select Isnull((Select Sum(Masuk)-Sum(Keluar) From T_StokBB where BBID=B.BBID and Tanggal<='" & F4 & "'),0)) As Stok From M_BB B Inner Join M_BBJns J On B.JnsID=J.JnsID Left Outer Join M_SuppBB S On B.BBID=S.BBID Where S.SuppID Like '" & F1 & "' and J.Gol Like'" & F2 & "%' and B.Aktif='True') as x Where Stok>0 Order By Bahan", koneksi)

                cmsl.TableMappings.Add("Table", "SrBBStokH" & F2)
                DsSearch = New System.Data.DataSet
                cmsl.Fill(DsSearch, "SrBBStokH" & F2)

                DsSearch.WriteXml("SrBBStokH" & F2 & ".xml", XmlWriteMode.WriteSchema)
            End If

            Me.GridControl1.DataSource = DsSearch
            Me.GridControl1.DataMember = "SrBBStokH" & F2
        ...
        ElseIf Master = "Purchase Request Sparepart" Then
            ...
            cmsl = New SqlDataAdapter("Select * From (Select H.PRSMID,PRSMIDD,Tanggal,D.BBID,Case When D.Ket='' Then B.Nama Else B.Nama +' ('+ D.Ket +')' End As Bahan,Qty-BtlOrder-(Select Isnull((Select Sum(Qty) From T_POBBDtl Where BOMID=H.PRSMID and DocIDD=D.PRSMIDD),0)) as Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID='" & F1 & "' and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,'False' as stsJasa,D.Sat From T_PRSpM H Inner Join T_PRSpMDtl D On H.PRSMID=D.PRSMID Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where Tipe='" & F2 & "' and Jenis='" & F3 & "' and S.SuppID='" & F1 & "') as x Where Qty>0", koneksi)
        ...
        ElseIf Master = "BB With BOM" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select * From (Select D.BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0)-(Select Isnull((Select Sum(Qty)-Sum(BtlOrder) From T_POBBDtl Where BOMID=D.BOMID and BBID=D.BBID and POID<>'" & F2 & "'),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.BOMID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,D.stsJasa From T_BOMDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where BOMID='" & F1 & "' and S.SuppID='" & F3 & "' And S.Aktif='True' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,BOMID,SuppID,D.stsJasa Union All Select D.BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0) -(Select Isnull((Select Sum(Qty)-Sum(BtlOrder) From T_POBBDtl Where BOMID=D.TambahanID and BBID=D.BBID and POID<>'" & F2 & "'),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.TambahanID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,D.stsJasa From T_BOMTamDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where TambahanID='" & F1 & "' and S.SuppID='" & F3 & "' And S.Aktif='True' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,TambahanID,SuppID,D.stsJasa Union All Select D.BBIDTj,B.Nama As Bahan,D.SatTj,Round(Sum(KebTj),0)-(Select Isnull((Select Sum(Qty)-Sum(BtlOrder) From T_POBBDtl Where BOMID=D.MemoID and BBID=D.BBIDTj and POID<>'" & F2 & "'),0)) As Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBIDTj and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,'False' As stsJasa From T_Memo H Inner Join T_MemoDtl D On H.MemoID=D.MemoID Inner Join M_BB B On D.BBIDTj=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where H.MemoID='" & F1 & "' and S.SuppID='" & F3 & "' And S.Aktif='True' and B.Aktif='True' and stsApp='True' Group By D.BBIDTj,B.Nama,D.SatTj,D.MemoID,SuppID) as x Order By Bahan", koneksi)
        ...
        ElseIf Master = "BB With Request" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select D.BBID,B.Nama As Bahan,D.Sat,Sum(Req) -(Select Isnull((Select Sum(Qty)-Sum(BtlOrder) From T_POBBDtl Where BOMID=D.ReqPID and BBID=D.BBID and POID<>'" & F2 & "'),0)) As Qty,(Select Isnull((Select Top 1 HargaBeli From M_BBHarga Where BBID=D.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc),0)) As Harga,D.stsJasa From T_ReqPDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_SuppBB S On B.BBID=S.BBID Where ReqPID='" & F1 & "' and S.SuppID='" & F3 & "' And S.Aktif='True' and B.Aktif='True' Group By D.BBID,B.Nama,D.Sat,ReqPID,SuppID,D.stsJasa Order By Bahan", koneksi)
        ...
        ElseIf Master = "BB No BOM" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select Distinct B.BBID,B.Nama As Bahan,Uk,B.Sat,(Select Isnull((Select Top 1 (HargaBeli*NilTukarRp)+HargaBahan From M_BBHarga Where BBID=B.BBID and SuppID=S.SuppID and HargaBeli<>0 Order By Tanggal desc,HargaIDD desc),0)) As Harga,Uk,stsJasa From M_BB B Inner Join M_BBJns J On B.JnsID=J.JnsID Inner Join M_SuppBB S On B.BBID=S.BBID Where S.SuppID Like '" & F1 & "' and J.Gol Like'" & F2 & "%' and B.Aktif='True' Order By B.Nama", koneksi)
        ...
        ElseIf Master = "BB BOM BtNum" Then
            ...
            If IO.File.Exists("SrBBBOMBtNum" & F1 & ".xml") Then
                System.IO.File.Delete("SrBBBOMBtNum" & F1 & ".xml")
            End If

            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select * From(Select '" & F5 & "'+BBID As BBID,BtNum As BatchNum,Bahan,Sat,Case When Qty>Stok Then Stok Else Qty End As Qty From (Select x.*,tbl.BtNum, tbl.Stok From (Select BOMID,D.BBID as BBID,B.Nama As Bahan,D.Sat,Round(Sum(Keb)+Sum(Pol),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.BOMID and BBID=D.BBID and H.BPBID<>'" & F2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.BOMID and BBID=D.BBID),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.BOMID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty From T_BOMDtl D Inner Join M_BB B On D.BBID=B.BBID Where BOMID='" & F1 & "' and B.Aktif='True' Group By BOMID,D.BBID,B.Nama,D.Sat) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & F3 & "' and Tanggal<='" & F4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID Union All Select x.*,tbl.BtNum, tbl.Stok From (Select TambahanID,D.BBID as BBID,B.Nama As Bahan,D.Sat, Round(Sum(Keb)+Sum(Pol),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.TambahanID and BBID=D.BBID and H.BPBID<>'" & F2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.TambahanID and BBID=D.BBID),0))-(Select Isnull((Select Round(Sum(KebAs),0) From T_Memo MH Inner Join T_MemoDtl MD On MH.MemoID=MD.MemoID Where BOMID=D.TambahanID and BBIDAs=D.BBID and stsApp='True'),0)) As Qty From T_BOMTamDtl D Inner Join M_BB B On D.BBID=B.BBID Where TambahanID='" & F1 & "' and B.Aktif='True' Group By TambahanID,D.BBID,B.Nama,D.Sat) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & F3 & "' and Tanggal<='" & F4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID Union All Select x.*,tbl.BtNum, tbl.Stok From (Select D.MemoID,D.BBIDTj as BBID,B.Nama As Bahan,D.SatTj,Round(Sum(KebTj),0)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.MemoID and BBID=D.BBIDTj and H.BPBID<>'" & F2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.MemoID and BBID=D.BBIDTj),0)) As Qty From T_Memo MH Inner Join T_MemoDtl D On MH.MemoID=D.MemoID Inner Join M_BB B On D.BBIDTj=B.BBID Where D.MemoID='" & F1 & "' and B.Aktif='True' and stsApp='True' Group By D.MemoID,D.BBIDTj,B.Nama,D.SatTj) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & F3 & "' and Tanggal<='" & F4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID) as y) as w Where Qty>0 Order By BBID", koneksi)
            ...
            DsSearch.WriteXml("SrBBBOMBtNum" & F1 & ".xml", XmlWriteMode.WriteSchema)
        ...
        ElseIf Master = "BB Request BtNum" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select * From(Select '" & F5 & "'+BBID As BBID,BtNum As BatchNum,Bahan,Sat,Case When Qty>Stok Then Stok Else Qty End As Qty From (Select x.*,tbl.BtNum, tbl.Stok From (Select ReqPID,D.BBID as BBID,B.Nama As Bahan,D.Sat,Ceiling(Sum(Req)-(Select Isnull((Select Sum(Qty) From T_BPB H Inner Join T_BPBDtl BD On H.BPBID=BD.BPBID Where DocID=D.ReqPID and BBID=D.BBID and H.BPBID<>'" & F2 & "'),0))+(Select Isnull((Select Sum(Qty) From T_RPB H Inner Join T_RPBDtl BD On H.RPBID=BD.RPBID Where DocID=D.ReqPID and BBID=D.BBID),0))) As Qty From T_ReqPDtl D Inner Join M_BB B On D.BBID=B.BBID Where ReqPID='" & F1 & "' and B.Aktif='True' Group By ReqPID,D.BBID,B.Nama,D.Sat) as x Inner Join (Select BBID,BtNum,Sum(Masuk)-Sum(Keluar) As Stok From T_StokBB Where GdID='" & F3 & "' and Tanggal<='" & F4 & "' Group By BBID,BtNum) As tbl On x.BBID=tbl.BBID) as y) as w Where Qty>0 Order By BBID", koneksi)
        ...
        ElseIf Master = "BB Model" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select BBID,Bahan,UkBB,Sat,Sum(Keb) As Keb From(Select BP.ArtCode,MD.DivID,Md.KompID,MD.BBID, B.Nama As Bahan,UkBB,MD.Sat,Std,Bp.Qty+BP.QtyPol-Bp.BtlOrder As Qty, Case when KaliQty='True' Then Round(Std*(Bp.Qty+BP.QtyPol-Bp.BtlOrder),2) Else Case When Std=0 Then 0 Else Round((Bp.Qty+BP.QtyPol-Bp.BtlOrder)/Std,2) End End As Keb From M_ModelDtl MD Inner Join T_BOM BM On MD.MdlID=BM.MdlID Inner Join T_BOMPO BP On BM.BOMID=BP.BOMID and MD.ArtCode=BP.ArtCode Inner Join M_BB B On MD.BBID=B.BBID Where MD.MdlID='" & F1 & "' and BM.BOMID='" & F2 & "' and MD.DivID='" & F3 & "' and MD.KompID='" & F5 & "') as x Group By DivID,KompID,BBID,Bahan,UkBB,Sat Union All Select BBID,Bahan,UkBB,Sat,Sum(Keb) As Keb From(Select BP.ArtCode,MD.DivID,Md.KompID,MD.BBID, B.Nama As Bahan,UkBB,MD.Sat,Std,Bp.Qty+BP.QtyPol-Bp.BtlOrder As Qty, Case when KaliQty='True' Then Round(Std*(Bp.Qty+BP.QtyPol-Bp.BtlOrder),2) Else Case When Std=0 Then 0 Else Round((Bp.Qty+BP.QtyPol-Bp.BtlOrder)/Std,2) End End As Keb From M_ModelDtl MD Inner Join T_BOMTam BT Inner Join T_BOM BM On BT.BOMID=BM.BOMID On MD.MdlID=BM.MdlID Inner Join T_BOMPO BP On BM.BOMID=BP.BOMID and MD.ArtCode=BP.ArtCode Inner Join M_BB B On MD.BBID=B.BBID Where MD.MdlID='" & F1 & "' and BT.TambahanID='" & F2 & "' and MD.DivID='" & F3 & "' and MD.KompID='" & F5 & "') as x Group By DivID,KompID,BBID,Bahan,UkBB,Sat", koneksi)
        ...
        ElseIf Master = "LPB" Then
            ...
            Dim cmsl As SqlDataAdapter
            cmsl = New SqlDataAdapter("Select POID,TrmID,Tanggal,GdID,DiscP,DiscRp,DiscRpSat From T_TrmBB Where SuppID='" & F1 & "' and TipePPn='" & F2 & "' and PersenPPn=" & F5 & " and MtUang='" & F3 & "' and Tanggal<='" & F4 & "' and stsTagih='False'", koneksi)
    ...
    Private Sub GridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.DoubleClick
        ...
        ElseIf Master = "Skema Komisi" Then
            dataTrans.Add(Me.GridView1.GetFocusedDataRow.Item("Tahun"), "Kode")
        ...
        ElseIf Master = "ProsesLine" Then
            dataTrans.Add(Me.GridView1.GetFocusedDataRow.Item("Proses"), "Kode")
            dataTrans.Add(Me.GridView1.GetFocusedDataRow.Item("Line"), "Line")
