...
Public Class FSampReq
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Public Indicator As Int16
    Dim arrPar(-1), ReqIDLama As String
    ...
    Public Sub LUE()
        ...
        cmsl = New SqlDataAdapter("Select CustID,Nama As Cust,ChaserID,PtMkID From M_Cust Where Aktif='True' and Umum='True'", koneksi)
        ...
        cmsl = New SqlDataAdapter("Select UserID,Nama From M_User Where Aktif='True' and UserID=" & MainModule.UserAktif & "", koneksi)
        cmsl.TableMappings.Add("Table", "MktLUE")
        Try
            DsMaster.Tables("MktLUE").Clear()
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select ReqIDD,ReqID,SampType,Uk,StyleID,StlName,Warna,Lastt,Qty,Ket,BtlOrder,SisaKirim,stsKirim From T_SampReqDtl Where ReqID='" & Kode & "'", koneksi)
        ...
        DsMaster.Tables("T_SampReqDtl").PrimaryKey = New DataColumn() {DsMaster.Tables("T_SampReqDtl").Columns("SampType"), DsMaster.Tables("T_SampReqDtl").Columns("StlName"), DsMaster.Tables("T_SampReqDtl").Columns("Uk"), DsMaster.Tables("T_SampReqDtl").Columns("Warna"), DsMaster.Tables("T_SampReqDtl").Columns("Ket")}
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select ReqID,Rev,ReqIDLama,H.PeriodID,CodeID,H.Tanggal,TglKirim,H.CustID,C.Nama As Cust,UserID,H.MktID,(Select Nama From M_User Where UserID=H.MktID) As Mkt,H.ChaserID,(Select Nama From M_User Where UserID=H.ChaserID) As Chaser,H.PtMkID,(Select Nama From M_User Where UserID=H.PtMkID) As PtMk,H.Ket,Stat,stsKirim,stsBatal,H.InsDate,H.InsBy,H.UpdDate,H.UpdBy,H.UpdDateCs,H.UpdByCs,H.BtlDate, H.BtlBy From T_SampReq H Inner Join M_Cust C On H.CustID=C.CustID Where PeriodID=" & MainModule.periodAktif & " Order By Tanggal,ReqID asc", koneksi)
    ...
    Public Sub NewEdit()
        ...
        Me.GridColumn52.OptionsColumn.AllowEdit = True
    End Sub
    ...
    Public Sub CancelOrder()
        ...
        Me.GridColumn16.OptionsColumn.AllowEdit = True
    ...
    Private Sub BVBNew_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBNew.ItemClick
        ...
        Me.SLUMkt.EditValue = MainModule.UserAktif
        Me.SLUChaser.EditValue = ""
        Me.TBRev.EditValue = 0
        Me.SLUPM.EditValue = ""
        Me.MKet.EditValue = ""
        Me.TBInfo.EditValue = ""
        ReqIDLama = ""
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        If SlSampReq(Me.GridView2.GetFocusedDataRow.Item("ReqID")) > 0 Then
            XtraMessageBox.Show("Data Tidak Bisa Diubah Karena Sudah Ada Pengiriman", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If

        If SlCek("T_SampReq", "stsBatal", "ReqID", Me.GridView2.GetFocusedDataRow.Item("ReqID")) = True Then
            XtraMessageBox.Show("Data Tidak Bisa Diubah Karena Sudah Dibatalkan", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        ...
        Me.TBRev.EditValue = Me.GridView2.GetFocusedDataRow.Item("Rev")
        ReqIDLama = Me.GridView2.GetFocusedDataRow.Item("ReqIDLama")
        ...
        Me.SLUPM.EditValue = Me.GridView2.GetFocusedDataRow.Item("PtMkID")
    ...
    Private Sub BVBCancelOrder_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBCancelOrder.ItemClick
        ...
        If SlCek("T_SampReq", "stsBatal", "ReqID", Me.GridView2.GetFocusedDataRow.Item("ReqID")) = True Then
            XtraMessageBox.Show("Data Tidak Bisa Dibatalkan Karena Sudah Dibatalkan", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        ...
        Select Case Indicator
            Case 100
                ...
                With cmSP
                    ...
                    .Parameters.Add("@Rev", SqlDbType.Int).Value = Me.TBRev.EditValue
                    .Parameters.Add("@ReqIDLama", SqlDbType.VarChar).Value = ReqIDLama
            ...
            Case 300
                ...
                Dim i : For i = 0 To GridView1.RowCount - 1
                    If Not IsDBNull(Me.GridView1.GetRowCellValue(i, "BBID")) Then
                        Dim cmSPDtl As New SqlCommand("SPBtlSampReq")
                        cmSPDtl.CommandType = CommandType.StoredProcedure

                        With cmSPDtl
                            .Parameters.Add("@Id", SqlDbType.Int).Value = Me.GridView1.GetRowCellValue(i, "ReqIDD")
                            .Parameters.Add("@Kode", SqlDbType.VarChar).Value = Me.TBKode.EditValue
                        ...
                        Catch ex As Exception
                            XtraMessageBox.Show("Proses Pembatalan Sample Request Gagal", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            XtraMessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Exit Sub
                        End Try
                ...
                If x = 0 Then
                    XtraMessageBox.Show("Proses Pembatalan Sample Reques Berhasil", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Else
                    XtraMessageBox.Show("Proses Pembatalan Sample Reques Gagal", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
        ...
        If Me.SLUCust.Properties.ReadOnly = False Then
            Try
                If Not IsDBNull(Me.SLUCust.EditValue) Then
                    ...
                    Me.SLUChaser.EditValue = DsMaster.Tables("M_CustSp").Select("CustID = '" & Me.SLUCust.EditValue & "'")(0).Item("ChaserID")
                    Me.SLUPM.EditValue = DsMaster.Tables("M_CustSp").Select("CustID = '" & Me.SLUCust.EditValue & "'")(0).Item("PtMkID")
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
       ...
       If e.Column Is GridView1.Columns("BtlOrder") Then
            ...
            command = New SqlCommand("Select Qty-(Select Isnull((Select Sum(Qty)+Sum(QtyRj) From T_TrmSR H Inner Join T_TrmSRDtl D On H.TrmSRID=D.TrmSRID Where ReqID=T_SampReqDtl.ReqID and ReqIDD=T_SampReqDtl.ReqIDD),0)) From T_SampReqDtl Where ReqID='" & Me.TBKode.EditValue & "' and ReqIDD=" & Me.GridView1.GetFocusedDataRow.Item("ReqIDD") & "", koneksi)
            ...
            If Me.GridView1.GetRowCellValue(e.RowHandle, "BtlOrder") > Sisa Then
                XtraMessageBox.Show("Batal Order Tidak Boleh Melebihi Qty Request", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
    ...
    Private Sub GridView1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles GridView1.KeyPress
        ...
        If view.FocusedColumn.FieldName = "SampType" Or view.FocusedColumn.FieldName = "Uk" Or view.FocusedColumn.FieldName = "Warna" Or view.FocusedColumn.FieldName = "Ket" Then
            If e.KeyChar = "'" Then
                e.Handled = True
            End If
        End If
    ...
    Private Sub BVTSampReq_up_ItemPressed(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVTSampReq_up.ItemPressed
        Me.BVBNew.Enabled = False
        Me.BVBEdit.Enabled = False
        Me.BVBCancelOrder.Enabled = False
        Me.BVBDelete.Enabled = False
        ...
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select convert(bit,'FALSE') as Cek,D.ReqIDD,H.ReqID,C.Nama As Cust,SampType,StyleID,StlName,Lastt,Warna,Uk,TglKirim, KetCs,Qty From T_SampReq H Inner Join T_SampReqDtl D On H.ReqID=D.ReqID Inner Join M_Cust C On H.CustID=C.CustID where D.stsKirim='False'", koneksi)
        'cmsl = New SqlDataAdapter("Select convert(bit,'FALSE') as Cek,D.ReqIDD,H.ReqID,C.Nama As Cust,SampType,StyleID,StlName,Lastt,Warna,Uk,TglKirim, KetCs,Qty From T_SampReq H Inner Join T_SampReqDtl D On H.ReqID=D.ReqID Inner Join M_Cust C On H.CustID=C.CustID where H.ChaserID=" & MainModule.UserAktif & " and D.stsKirim='False'", koneksi)

        cmsl.TableMappings.Add("Table", "T_SampReqCs")
        cmsl.Fill(DsMaster, "T_SampReqCs")
        DsMaster.Tables("T_SampReqCs").Clear()
        cmsl.Fill(DsMaster, "T_SampReqCs")

        Me.GridControl3.DataSource = DsMaster
        Me.GridControl3.DataMember = "T_SampReqCs"
    End Sub
        ...
        Dim i : For i = 0 To GridView3.RowCount - 1
            If Me.GridView3.GetRowCellValue(i, "Cek") = True Then
                If Not IsDBNull(Me.GridView3.GetRowCellValue(i, "ReqID")) Then
                    Dim cmSPDtl As New SqlCommand("SPUpT_SampReqCs")
                    cmSPDtl.CommandType = CommandType.StoredProcedure

                    Dim x As Integer

                    With cmSPDtl
                        .Parameters.Add("@Id", SqlDbType.Int).Value = Me.GridView3.GetRowCellValue(i, "ReqIDD")
                        .Parameters.Add("@Kode", SqlDbType.VarChar).Value = Me.GridView3.GetRowCellValue(i, "ReqID")
                        .Parameters.Add("@StyleID", SqlDbType.VarChar).Value = Me.GridView3.GetRowCellValue(i, "StyleID")
                        .Parameters.Add("@StlName", SqlDbType.VarChar).Value = Me.GridView3.GetRowCellValue(i, "StlName")
                        .Parameters.Add("@Last", SqlDbType.VarChar).Value = Me.GridView3.GetRowCellValue(i, "Lastt")
                        .Parameters.Add("@KetCs", SqlDbType.VarChar).Value = Me.GridView3.GetRowCellValue(i, "KetCs")
                        .Parameters.Add("@By", SqlDbType.VarChar).Value = MainModule.InisialAktif
                        .Parameters.Add("@Return", SqlDbType.Int)
                        .Parameters("@Return").Direction = ParameterDirection.Output
                        .Connection = koneksi
                    ...
                    With koneksi
                        .Open()
                        cmSPDtl.ExecuteNonQuery()
                        x1 = cmSPDtl.Parameters("@Return").Value
                        .Close()
                    End With
    ...
    Private Sub GridView3_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView3.CellValueChanged
        If e.Column Is GridView3.Columns("Cek") Then

            If Me.GridView3.GetFocusedRowCellValue("Cek") = True Then
                Me.GridView3.Columns("Lastt").OptionsColumn.AllowEdit = True
                Me.GridView3.Columns("StyleID").OptionsColumn.AllowEdit = True
                Me.GridView3.Columns("KetCs").OptionsColumn.AllowEdit = True

            Else
                Me.GridView3.Columns("Lastt").OptionsColumn.AllowEdit = False
                Me.GridView3.Columns("StyleID").OptionsColumn.AllowEdit = False
                Me.GridView3.Columns("KetCs").OptionsColumn.AllowEdit = False

            End If

        ElseIf e.Column Is GridView3.Columns("StyleID") Then
            ...
            Dim x : For x = Me.GridView3.RowCount - 1 To 0 Step -1
                If Me.GridView3.GetRowCellValue(x, "ReqID") = Me.GridView3.GetFocusedDataRow.Item("ReqID") And Me.GridView3.GetRowCellValue(x, "StlName") = Me.GridView3.GetFocusedDataRow.Item("StlName") Then
                    Me.GridView3.SetRowCellValue(x, "StyleID", Me.GridView3.GetFocusedDataRow.Item("StyleID"))
                    Me.GridView3.SetRowCellValue(x, "Cek", True)
        ...
        ElseIf e.Column Is GridView3.Columns("Lastt") Then
            RemoveHandler GridView3.CellValueChanged, AddressOf GridView3_CellValueChanged

            Dim x : For x = Me.GridView3.RowCount - 1 To 0 Step -1
                If Me.GridView3.GetRowCellValue(x, "ReqID") = Me.GridView3.GetFocusedDataRow.Item("ReqID") And Me.GridView3.GetRowCellValue(x, "StlName") = Me.GridView3.GetFocusedDataRow.Item("StlName") Then
                    Me.GridView3.SetRowCellValue(x, "Lastt", Me.GridView3.GetFocusedDataRow.Item("Lastt"))
                    Me.GridView3.SetRowCellValue(x, "Cek", True)
    ...
    Private Sub GridView3_FocusedRowChanged(sender As Object, e As Views.Base.FocusedRowChangedEventArgs) Handles GridView3.FocusedRowChanged
        If Me.GridView3.GetFocusedRowCellValue("Cek") = True Then
            Me.GridView3.Columns("Lastt").OptionsColumn.AllowEdit = True
            Me.GridView3.Columns("StyleID").OptionsColumn.AllowEdit = True
            Me.GridView3.Columns("KetCs").OptionsColumn.AllowEdit = True
    ...
    Private Sub GridView3_KeyPress(sender As Object, e As KeyPressEventArgs) Handles GridView3.KeyPress
        ...
        If view.FocusedColumn.FieldName = "Lastt" Or view.FocusedColumn.FieldName = "KetCs" Then
            If e.KeyChar = "'" Then
                e.Handled = True
            End If
        End If
    ...
    Private Sub BRev_Click(sender As Object, e As EventArgs) Handles BRev.Click
        Dim frm As New FSearch("Samp Req", Me.SLUMkt.EditValue, "", "", Date.Now, "")
        frm.ShowDialog()

        Try
            If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
                Me.TBKode.EditValue = "--"
                Me.TBRev.EditValue = CInt(dataTrans.Item("Rev").ToString) + 1
                Me.SLUCust.EditValue = dataTrans.Item("CustID").ToString
                Me.SLUChaser.EditValue = dataTrans.Item("ChaserID").ToString
                Me.SLUPM.EditValue = dataTrans.Item("PtMkID").ToString

                Dim i : For i = Me.GridView1.RowCount - 1 To 0 Step -1
                    ReDim Preserve arrPar(arrPar.GetUpperBound(0) + 1)
                    arrPar(arrPar.GetUpperBound(0)) = Me.GridView1.GetRowCellValue(i, "ReqIDD")

                    Me.GridView1.DeleteRow(i)
                Next

                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select ROW_NUMBER() over (ORDER BY SD.Warna)*-1 as ReqIDD,SD.ReqID,SD.SampType,SD.StyleID,SD.StlName, SD.Lastt,SD.Warna,SD.Uk,SD.Qty,Ket,BtlOrder,SisaKirim,stsKirim From T_SampReqDtl SD Inner Join T_TrmSRDtl TD On SD.ReqID=TD.ReqID and TD.ReqIDD=SD.ReqIDD Where SD.ReqID='" & dataTrans.Item("Kode").ToString & "' and QtyRj>0", koneksi)
                ...
                DsMaster.Tables("T_SampReqDtl").PrimaryKey = New DataColumn() {DsMaster.Tables("T_SampReqDtl").Columns("SampType"), DsMaster.Tables("T_SampReqDtl").Columns("StlName"), DsMaster.Tables("T_SampReqDtl").Columns("Warna"), DsMaster.Tables("T_SampReqDtl").Columns("Uk"), DsMaster.Tables("T_SampReqDtl").Columns("Ket")}
