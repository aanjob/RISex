...
Public Class XXFSampReq
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select ReqIDD,ReqID,SampType,Uk,Qty,Warna,Ket,BtlOrder,SisaKirim,stsKirim From T_SampReqDtl Where ReqID='" & Kode & "'", koneksi)
        ...
        DsMaster.Tables("T_SampReqDtl").PrimaryKey = New DataColumn() {DsMaster.Tables("T_SampReqDtl").Columns("SampType"), DsMaster.Tables("T_SampReqDtl").Columns("Uk"), DsMaster.Tables("T_SampReqDtl").Columns("Warna"), DsMaster.Tables("T_SampReqDtl").Columns("Ket")}
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select ReqID,Rev,ReqIDLama,H.PeriodID,CodeID,H.Tanggal,TglKirim,H.CustID,C.Nama As Cust,UserID,H.MktID,(Select Nama From M_User Where UserID=H.MktID) As Mkt,H.ChaserID,(Select Nama From M_User Where UserID=H.ChaserID) As Chaser,H.PtMkID,(Select Nama From M_User Where UserID=H.PtMkID) As PtMk,StlName,StyleID,Lastt,H.Ket,Stat,stsKirim,stsBatal,H.InsDate,H.InsBy,H.UpdDate, H.UpdBy,H.UpdDateCs,H.UpdByCs,H.BtlDate,H.BtlBy From T_SampReq H Inner Join M_Cust C On H.CustID=C.CustID Where PeriodID=" & MainModule.periodAktif & " Order By Tanggal,ReqID asc", koneksi)
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        StlID = Me.GridView2.GetFocusedDataRow.Item("StyleID")
        Last = Me.GridView2.GetFocusedDataRow.Item("Lastt")
            ...
            With cmSP
                ...
                Try
                    ...
                    If x = 0 Then
                        ...
                        FillDt()
                    ElseIf x = 1 Then
                        XtraMessageBox.Show("Data Tidak Bisa Dibatalkan Karena Sudah Lunas Terkirim", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    End If
        ...
        Select Case Indicator
            Case 100
                ...
                With cmSP
                    ...
                    .Parameters.Add("@StyleID", SqlDbType.VarChar).Value = StlID
                    .Parameters.Add("@Lastt", SqlDbType.VarChar).Value = Last
    ...
    Private Sub BVTSampReq_up_ItemPressed(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVTSampReq_up.ItemPressed
        ...
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select convert(bit,'FALSE') as Cek,D.ReqIDD,H.ReqID,C.Nama As Cust,StyleID,StlName,Warna,SampType,TglKirim, KetCs,Lastt,Uk,Qty From T_SampReq H Inner Join T_SampReqDtl D On H.ReqID=D.ReqID Inner Join M_Cust C On H.CustID=C.CustID where H.ChaserID=" & MainModule.UserAktif & " and D.stsKirim='False'", koneksi)
    ...
    Private Sub GridView3_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView3.CellValueChanged
        ...
        ElseIf e.Column Is GridView3.Columns("StyleID") Then
            ...
            Dim x : For x = Me.GridView3.RowCount - 1 To 0 Step -1
                If Me.GridView3.GetRowCellValue(x, "ReqID") = Me.GridView3.GetFocusedDataRow.Item("ReqID") Then
    ...
    Private Sub BRev_Click(sender As Object, e As EventArgs) Handles BRev.Click
        ...
        Try
            If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
                ...
                Me.TBStlName.EditValue = dataTrans.Item("StlName").ToString

                StlID = dataTrans.Item("StyleID").ToString
                Last = dataTrans.Item("Lastt").ToString
                ...
                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select ROW_NUMBER() over (ORDER BY SD.Warna)*-1 as ReqIDD,SD.ReqID,SD.SampType,SD.Uk,SD.Qty,SD.Warna, Ket,BtlOrder,SisaKirim,stsKirim From T_SampReqDtl SD Inner Join T_TrmSRDtl TD On SD.ReqID=TD.ReqID and TD.ReqIDD=SD.ReqIDD Where SD.ReqID='" & dataTrans.Item("Kode").ToString & "' and QtyRj>0", koneksi)
