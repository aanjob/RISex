...
Public Class xxXRSampReqLama
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter
    Dim SumQty As DevExpress.XtraReports.UI.XRSummary = New DevExpress.XtraReports.UI.XRSummary

    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select SampType,Uk,Qty,Warna,Ket From T_SampReqDtl Where ReqID ='" & Bind.Item("Kode").ToString & "'", koneksi)
        ...
        Me.LBStlName.Text = ": " & Bind.Item("StlName").ToString
