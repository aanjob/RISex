...
Public Class FTrmSR
    ...
    Private Sub FSampReq_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        CekSave = False
    End Sub
    Private Sub FTrmSR_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        If Math.Round(CType(Me.GridView1.Columns("Qty").SummaryText, Decimal), 1) = 0 Then
            XtraMessageBox.Show("Qty Tidak Boleh Kosong", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
