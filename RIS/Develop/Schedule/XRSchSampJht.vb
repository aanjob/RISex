...
Public Class XRSchSampJht
    ...
    Public Sub InitializeData()
        ...
        Me.GroupHeader1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("TglJht", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        Me.LBTglGHJahit.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.TglJht", "Tanggal Jahit : {0:dd MMMM yyyy}")})
        Me.LBGFTglJht.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.TglJht", "Total Qty Assembling Tanggal {0:dd MMMM yyyy}")})
