...
Public Class XRSchSampCust
    ...
    Public Sub InitializeData()
        ...
        Me.LBGHCust.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.Cust", "Customer : {0}")})
        ...
        Me.LBTglJht.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.TglJht", "{0:dd/MM}")})
        Me.LBTglAss.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.TglAss", "{0:dd/MM}")})
        Me.LBGFCust.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_SchPrSamp.Cust", "Total Qty Customer {0:}")})
