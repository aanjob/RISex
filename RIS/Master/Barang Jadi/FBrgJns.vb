...
Public Class FBrgJns
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Public Indicator As Int16
    Dim KdLama As String

    Sub CekAkses()
        Me.BVBNew.Enabled = CType(TcodeCollection.Item("JnsJN"), Boolean)
        Me.BVBEdit.Enabled = CType(TcodeCollection.Item("JnsJEd"), Boolean)
        Me.BVBDelete.Enabled = CType(TcodeCollection.Item("JnsJDel"), Boolean)
    End Sub
    ...
    Public Sub FillDt()
        ...
        cmsl = New SqlDataAdapter("Select JnsID,Nama,Aktif,InsDate,InsBy,UpdDate,UpdBy From M_BrgJns", koneksi)

        cmsl.TableMappings.Add("Table", "M_BrgJns")
        'DsMaster = New System.Data.DataSet
        cmsl.Fill(DsMaster, "M_BrgJns")
        DsMaster.Tables("M_BrgJns").Clear()
        cmsl.Fill(DsMaster, "M_BrgJns")

        Me.GridControl1.DataSource = DsMaster
        Me.GridControl1.DataMember = "M_BrgJns"
    End Sub

    Private Sub FBrgJns_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Master Jenis Barang Jadi"
    End Sub

    Private Sub FBrgJns_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LockControl()
        Me.BVTJns_e.Selected = True
    End Sub
    ...
    Private Sub BVTJns_s_ItemPressed(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVTJns_s.ItemPressed
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Search Master Jenis Barang Jadi"

        FillDt()
    End Sub

    Private Sub BVBNew_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBNew.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Create Master Jenis Barang Jadi"
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Edit Master Jenis Barang Jadi"
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Delete Master Jenis Barang Jadi"
        ...
        If XtraMessageBox.Show("Apakah Anda Mau Menghapus Jenis : " & Me.GridView1.GetFocusedDataRow.Item("Nama") & " Ini ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            Dim cmSP As New SqlCommand("SPDelM_BrgJns")
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Select Case Indicator
            Case 100
                Dim cmSP As New SqlCommand("SPInsM_BrgJns")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
                ...
                End With
            Case 200
                Dim cmSP As New SqlCommand("SPUpM_BrgJns")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
