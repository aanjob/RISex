    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        If e.Column Is GridView1.Columns("Qty") Then
            If Me.CBOJns.EditValue <> "Lain-Lain" Then
                ...
                Dim Sisa As Integer
                Dim command As New SqlCommand("Select Distinct Case When P.ArtCodeInd=P.ArtCode Then P.Qty-P.Upp-P.Hancur-P.Hilang-(Select Isnull((Select Sum(Qty) From T_BSTBDtl Where BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and BSTBID<>'" & Me.TBKode.EditValue & "'),0)) Else (TotPsg/" & Me.GridView1.GetRowCellValue(e.RowHandle, "Isi") & ")-(Select Isnull((Select Sum(Qty) From T_BSTBDtl Where BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and BSTBID<>'" & Me.TBKode.EditValue & "'),0)) End As Qty From T_BOMPO P Inner Join T_BOM H On H.BomID=P.BOMID Where H.BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCodeInd='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and H.Gol='Job Order' Union All Select Distinct Case When P.ArtCodeInd=P.ArtCode Then P.Qty-P.Upp-P.hancur-P.Hilang-(Select Isnull((Select Sum(Qty) From T_BSTBDtl Where BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and BSTBID<>'" & Me.TBKode.EditValue & "'),0)) Else (TotPsg/" & Me.GridView1.GetRowCellValue(e.RowHandle, "Isi") & ")-(Select Isnull((Select Sum(Qty) From T_BSTBDtl Where BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and BSTBID<>'" & Me.TBKode.EditValue & "'),0)) End As Qty From T_BOMPO P Inner Join T_BOM H On H.BomID=P.BOMID Where H.BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and H.Gol='Job Order' Union All Select ((H.TotPsg+H.TotPsgPol)/" & Me.GridView1.GetRowCellValue(e.RowHandle, "Isi") & ")-(Select Isnull((Select Sum(Qty) From T_BSTBDtl Where BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' and BSTBID<>'" & Me.TBKode.EditValue & "'),0)) As Qty From T_BOM H  Inner Join T_POBJLkDtl P On H.POID=P.POID Where H.BOMID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "BOMID") & "' and (ArtCode='" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' Or '" & Me.GridView1.GetRowCellValue(e.RowHandle, "ArtCode") & "' In (Select ArtCode From T_POBJLkDtl2 Where POID=H.POID)) and H.Gol<>'Job Order'", koneksi)
