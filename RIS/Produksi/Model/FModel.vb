...
Public Class FModel
    ...
    Public Sub FillDtl(Kode As String)
        ...
        'Dim command2 As New SqlCommand("Select Isnull(Max(Len(Ass)),0) From M_Brg B Inner Join M_BrgWrn W On B.WrnID=W.WrnID Inner Join M_ModelDtl D On D.ArtCode=B.ArtCode Where MdlID ='" & Kode & "' and Ass Like '%x%'", koneksi)
    ...
    Public Sub FillDtlCpPilih(Data As String)
        ...
        Dim y : For y = 0 To Me.GridView3.RowCount - 1
            Dim z : For z = 0 To DsMaster.Tables("M_ModelDtlTempCpP").Rows.Count - 1
                Dim x : For x = 0 To DsMaster.Tables("M_ModelDtl").Rows.Count - 1

                    If DsMaster.Tables("M_ModelDtl").Rows(x).Item("DivID") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("DivID") And DsMaster.Tables("M_ModelDtl").Rows(x).Item("KompID") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("KompID") And DsMaster.Tables("M_ModelDtl").Rows(x).Item("BBID") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("BBID") And Me.GridView3.GetRowCellValue(y, "Uk") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("UkBJ") And DsMaster.Tables("M_ModelDtl").Rows(x).Item("BBIDInd") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("BBIDInd") Then

                        Me.GridView1.SetRowCellValue(x, Me.GridView3.GetRowCellValue(y, "ArtCode"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Std"))
                        Masuk = False
                        Exit For
                    Else
                        Masuk = True
                ...
                If Masuk = True Then
                    If Me.GridView3.GetRowCellValue(y, "Uk") = DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("UkBJ") Then
                        DsMaster.Tables("M_ModelDtl").Rows.Add(True, Me.TBKode.EditValue, DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("SpecIDD"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("DivID"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Divisi"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("KompID"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Komponen"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("BBID"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Bahan"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("UkBB"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Sat"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Ket"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("stsAuto"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("KaliQty"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("SPK"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Urut"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Urut1"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("stsJasa"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("stsMentah"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("BBIDInd"), DsMaster.Tables("M_ModelDtlTempCpP").Rows(z).Item("Std"))
                    End If
                End If
            Next
        Next
    ...
    Public Sub FillDtlCp(Kode As String)
        ...
        Dim y : For y = 0 To Me.GridView3.RowCount - 1
            Dim z : For z = 0 To DsMaster.Tables("M_ModelDtlTemp").Rows.Count - 1
                Dim x : For x = 0 To DsMaster.Tables("M_ModelDtl").Rows.Count - 1
                    'MsgBox(Me.GridView3.GetRowCellValue(y, "Uk") & " = " & DsMaster.Tables("M_ModelDtlTemp").Rows(z).Item("UkBJ"))
    ...
    Private Sub SLUSpec_Leave(sender As Object, e As EventArgs) Handles SLUSpec.Leave
        If Not IsDBNull(Me.SLUSpec.EditValue) And Me.SLUSpec.Properties.ReadOnly = False Then
            Try
                ...
                koneksi.Close()
                'MsgBox(Me.TBArtName.EditValue)
                'MsgBox(Me.TBWarna.EditValue)
                ...
                'MsgBox(jml)
                If jml > 4 Then
                    cmsl = New SqlDataAdapter("Select ArtCode,Ass As Uk From M_Brg B Inner Join M_BrgWrn W On B.WrnID=W.WrnID Where ArtName='" & Me.TBArtName.EditValue & "' And W.Nama='" & Me.TBWarna.EditValue & "' And SatID In ('P','PCS') and B.aktif=1 Order By Uk", koneksi)
                Else
                    'MsgBox(assx)
                    'MsgBox(Me.TBArtName.EditValue)
                    'MsgBox(Me.TBWarna.EditValue)
                    If assx > 0 Then
                        cmsl = New SqlDataAdapter("Select ArtCode,Ass As Uk From M_Brg B Inner Join M_BrgWrn W On B.WrnID=W.WrnID Where ArtName='" & Me.TBArtName.EditValue & "' And W.Nama='" & Me.TBWarna.EditValue & "' And SatID In ('P','PCS') and B.aktif=1 Order By Uk", koneksi)
                    Else
                        cmsl = New SqlDataAdapter("Select ArtCode,Ass As Uk From M_Brg B Inner Join M_BrgWrn W On B.WrnID=W.WrnID Where ArtName='" & Me.TBArtName.EditValue & "' And W.Nama='" & Me.TBWarna.EditValue & "' And SatID In ('P','PCS') and B.aktif=1 Order By Cast(Ass as Decimal(18,2))", koneksi)
                    End If
    ...
    Private Sub BCopyPilih_Click(sender As Object, e As EventArgs) Handles BCopyPilih.Click
        Dim frm As New FModel_cp()
        frm.ShowDialog()
        frm.Close()

        Try
            FillDtlCpPilih(MdlCp)
        Catch ex As Exception
