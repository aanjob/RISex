...
Public Class FSisaBOMv1
    ...
    Private Sub FSisaBOM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmsl = New SqlDataAdapter("Select BOMIDD,B.BOMID,B.Rev,BP.POID,BP.ArtCodeInd,BP.ArtCode,B.ArtName,BP.SatID,BP.Isi,BP.IsiDlmDos,BP.Uk, Qty,QtyPol,Tot,BP.TotQtyR1,BP.TotQtyR2,BP.TotQtyR3,BP.BtlOrder,BP.Upp,BP.Hancur,BP.Hilang,BP.LunasMan From T_BOM B Inner Join T_BOMPO BP On B.BOMID=BP.BOMID Where B.BOMID='" & KdBOM & "'", koneksi)
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        If e.Column Is GridView1.Columns("BtlOrder") Then
            ...
            If Me.GridView1.GetRowCellValue(e.RowHandle, "Rev") = 0 Then
                SisaPsg = Me.GridView1.GetRowCellValue(e.RowHandle, "Tot") - (BSTB * Me.GridView1.GetRowCellValue(e.RowHandle, "IsiDlmDos"))

            ElseIf Me.GridView1.GetRowCellValue(e.RowHandle, "Rev") = 1 Then
                SisaPsg = Me.GridView1.GetRowCellValue(e.RowHandle, "TotQtyR1") - (BSTB * Me.GridView1.GetRowCellValue(e.RowHandle, "IsiDlmDos"))

            ElseIf Me.GridView1.GetRowCellValue(e.RowHandle, "Rev") = 2 Then
                SisaPsg = Me.GridView1.GetRowCellValue(e.RowHandle, "TotQtyR2") - (BSTB * Me.GridView1.GetRowCellValue(e.RowHandle, "IsiDlmDos"))
            ElseIf Me.GridView1.GetRowCellValue(e.RowHandle, "Rev") = 3 Then
                SisaPsg = Me.GridView1.GetRowCellValue(e.RowHandle, "TotQtyR3") - (BSTB * Me.GridView1.GetRowCellValue(e.RowHandle, "IsiDlmDos"))
