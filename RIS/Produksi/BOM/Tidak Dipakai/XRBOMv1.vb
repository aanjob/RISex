...
Public Class XRBOMv1
    ...
    Public Sub InitializeData(ByVal Bind As Collection, Revisi As String)
        If Revisi = "0" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi,K.Urut,K.Nama As Komponen,B.Nama As Bahan,B.Uk As UkBB, BD.Sat,Sum(Keb)+Sum(Pol) as Keb,Round(Sum(Keb)+Sum(Pol),0) As TotKeb, BD.Ket From T_BOMDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BOMID='" & Bind.Item("Kode").ToString & "' Group By D.Urut,D.Nama,K.Urut,K.Nama,B.Nama,B.Uk, BD.Sat,BD.Ket Order By D.Urut,K.Urut,B.Nama Asc", koneksi)

            Me.LBRevisi.Text = ""

        ElseIf Revisi = "1" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi,K.Urut,K.Nama As Komponen,B.Nama As Bahan,B.Uk As UkBB, BD.Sat,Sum(KebR1) as Keb,Round(Sum(KebR1),0) As TotKeb, BD.Ket From T_BOMDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BOMID='" & Bind.Item("Kode").ToString & "' Group By D.Urut,D.Nama,K.Urut,K.Nama,B.Nama,B.Uk, BD.Sat,BD.Ket Order By D.Urut,K.Urut,B.Nama Asc", koneksi)

            Me.LBRevisi.Text = "Revisi 1"

        ElseIf Revisi = "2" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi,K.Urut,K.Nama As Komponen,B.Nama As Bahan,B.Uk As UkBB,BD.Sat,Sum(KebR2) as Keb,Round(Sum(KebR2),0) As TotKeb, BD.Ket From T_BOMDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BOMID='" & Bind.Item("Kode").ToString & "' Group By D.Urut,D.Nama,K.Urut,K.Nama,B.Nama,B.Uk, BD.Sat,BD.Ket Order By D.Urut,K.Urut,B.Nama Asc", koneksi)

            Me.LBRevisi.Text = "Revisi 2"

        ElseIf Revisi = "3" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi,K.Urut,K.Nama As Komponen,B.Nama As Bahan,B.Uk As UkBB,BD.Sat,Sum(KebR3) as Keb,Round(Sum(KebR3),0) As TotKeb, BD.Ket From T_BOMDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BOMID='" & Bind.Item("Kode").ToString & "' Group By D.Urut,D.Nama,K.Urut,K.Nama,B.Nama,B.Uk, BD.Sat,BD.Ket Order By D.Urut,K.Urut,B.Nama Asc", koneksi)
        ...
        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_BOMDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("Divisi", "Divisi"), New System.Data.Common.DataColumnMapping("Komponen", "Komponen"), New System.Data.Common.DataColumnMapping("BBID", "BBID"), New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("UkBB", "UkBB"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("Keb", "Keb"), New System.Data.Common.DataColumnMapping("TotKeb", "TotKeb"), New System.Data.Common.DataColumnMapping("Ket", "Ket")})})
        ...
        Me.LBKebBahan.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMDtl.Keb")})
        Me.LBTotKeb.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMDtl.TotKeb")})
