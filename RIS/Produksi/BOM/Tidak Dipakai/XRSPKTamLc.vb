...
Public Class XRSPKTamLc
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        ...
        Me.LBGUk1.Text = Bind.Item("Uk1").ToString
        Me.LBGUk2.Text = Bind.Item("Uk2").ToString
        Me.LBGUk3.Text = Bind.Item("Uk3").ToString
        Me.LBGUk4.Text = Bind.Item("Uk4").ToString
        Me.LBGUk5.Text = Bind.Item("Uk5").ToString
        Me.LBGUk6.Text = Bind.Item("Uk6").ToString
        Me.LBGUk7.Text = Bind.Item("Uk7").ToString
        Me.LBGUk8.Text = Bind.Item("Uk8").ToString
        ...
        Me.LBGHBBIDInd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMDtl.BBIDInd")})
    ...
    Private Sub GHDiv_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles GHDiv.BeforePrint
        Hal = 0
    End Sub
