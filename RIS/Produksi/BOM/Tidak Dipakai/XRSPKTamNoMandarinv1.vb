...
Public Class XRSPKTamNoMandarinv1
    ...
    Public Sub InitializeData(ByVal Bind As Collection, Revisi As String)
        If Revisi = "0" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi, BD.KompID, K.Nama As Komponen, BD.BBID, B.Nama As Bahan, BD.UkBB, BD.Sat, Round(Std,2) as Std,Keb,BD.Uk,BD.Ket,stsAdd,BBIDInd From T_BOMTamDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BD.TambahanID='" & Bind.Item("Kode").ToString & "' and ArtCode In (Select ArtCode From T_BOMPO where BOMID='" & Bind.Item("BOMID").ToString & "') and SPK='True' Order By D.Urut,K.Urut,K.Nama,B.Nama,BD.Uk,BBIDInd Asc", koneksi)

            Me.LBRevisi.Text = ""

        ElseIf Revisi = "1" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi, BD.KompID, K.Nama As Komponen, BD.BBID, B.Nama As Bahan, BD.UkBB, BD.Sat, Round(Std,2) as Std,KebR1 As Keb,BD.Uk,BD.Ket,stsAdd,BBIDInd From T_BOMTamDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BD.TambahanID='" & Bind.Item("Kode").ToString & "' and ArtCode In (Select ArtCode From T_BOMPO where BOMID='" & Bind.Item("BOMID").ToString & "') and SPK='True' Order By D.Urut,K.Urut,K.Nama,B.Nama,BD.Uk,BBIDInd Asc", koneksi)
            Me.LBRevisi.Text = "Revisi 1"

        ElseIf Revisi = "2" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi, BD.KompID, K.Nama As Komponen, BD.BBID, B.Nama As Bahan, BD.UkBB, BD.Sat, Round(Std,2) as Std,KebR2 As Keb,BD.Uk,BD.Ket,stsAdd,BBIDInd From T_BOMTamDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BD.TambahanID='" & Bind.Item("Kode").ToString & "' and ArtCode In (Select ArtCode From T_BOMPO where BOMID='" & Bind.Item("BOMID").ToString & "') and SPK='True' Order By D.Urut,K.Urut,K.Nama,B.Nama,BD.Uk,BBIDInd Asc", koneksi)
            Me.LBRevisi.Text = "Revisi 2"

        ElseIf Revisi = "3" Then
            cmsl = New SqlDataAdapter("Select D.Urut,D.Nama as Divisi, BD.KompID, K.Nama As Komponen, BD.BBID, B.Nama As Bahan, BD.UkBB, BD.Sat, Round(Std,2) as Std,KebR3 As Keb,BD.Uk,BD.Ket,stsAdd,BBIDInd From T_BOMTamDtl BD Inner Join M_Div D On BD.DivID=D.DivID Inner Join M_Komp K On BD.KompID=K.KompID Inner Join M_BB B On BD.BBID=B.BBID Where BD.TambahanID='" & Bind.Item("Kode").ToString & "' and ArtCode In (Select ArtCode From T_BOMPO where BOMID='" & Bind.Item("BOMID").ToString & "') and SPK='True' Order By D.Urut,K.Urut,K.Nama,B.Nama,BD.Uk,BBIDInd Asc", koneksi)

            Me.LBRevisi.Text = "Revisi 3"

        End If



        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_BOMTamDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("Urut", "Urut"), New System.Data.Common.DataColumnMapping("Divisi", "Divisi"), New System.Data.Common.DataColumnMapping("KompID", "KompID"), New System.Data.Common.DataColumnMapping("Komponen", "Komponen"), New System.Data.Common.DataColumnMapping("BBID", "BBID"), New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("UkBB", "UkBB"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("Std", "Std"), New System.Data.Common.DataColumnMapping("Keb", "Keb"), New System.Data.Common.DataColumnMapping("Uk", "Uk"), New System.Data.Common.DataColumnMapping("Ket", "Ket"), New System.Data.Common.DataColumnMapping("stsAdd", "stsAdd")})})

        DsLap = New System.Data.DataSet
        Try
            DsLap.Tables("T_BOMTamDtl").Clear()
        ...
        Me.LBKode.Text = "ID Tambahan 备注 : " & Bind.Item("Kode").ToString
        Me.LBSPK.Text = ": " & Bind.Item("SPK").ToString
        ...
        Me.LBSampSize.Text = ": " & Bind.Item("SampleSize").ToString
        ...
        Me.GHBBIDInd.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LBBB})
        ...
        Me.LBGHBBIDInd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.BBIDInd")})
        ...
        Me.LBKomponen.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.Komponen")})
        ...
        Me.LBBB.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.Bahan")})
        ...
        Me.LBUk.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.Uk")})
        Me.LBStd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.Std")})
        Me.LBAdd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.stsAdd")})

        Me.LBKeb.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_BOMTamDtl.Keb", "{0:n2}")})
