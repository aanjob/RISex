...
Public Class XRLapProd2
    ...
    Public Sub InitializeData()
        ...
        Me.LBCuttUpBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.CuttUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        ...
        Me.LBCuttBotBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.CuttBottBal", "{0:#,##0.0;(#,##0.0);""}")})
        ...
        Me.LBSeriBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SeriBal", "{0:#,##0.0;(#,##0.0);""}")})
        ...
        Me.LBSabUpTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabUpp", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSabUpBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSabUpTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabUppTar", "{0:#,##0.0;(#,##0.0);""}")})

        Me.LBSabInsTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabIns", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSabInsBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabInsBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSabInsTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabInsTar", "{0:#,##0.0;(#,##0.0);""}")})

        Me.LBJhtKTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtKomp", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBJhtKBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtKompBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBJhtKTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtKompTar", "{0:#,##0.0;(#,##0.0);""}")})

        Me.LBJhtTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtUpp", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBJhtBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBJhtTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtUppTar", "{0:#,##0.0;(#,##0.0);""}")})

        Me.LBSoleTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.Outsole", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSoleBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.OutsoleBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBSoleTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.OutsoleTar", "{0:#,##0.0;(#,##0.0);""}")})

        Me.LBAssTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.Ass", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBAssBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.AssBal", "{0:#,##0.0;(#,##0.0);""}")})
        Me.LBAssTar.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.AssTar", "{0:#,##0.0;(#,##0.0);""}")})
        ...
        Me.LBPackBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.PackBal", "{0:#,##0.0;(#,##0.0);""}")})
        ...
        Me.LBGFCuttUpTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.CuttUpp", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFCuttUpp.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFCuttUpp.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFCuttUpTd.Summary = SumGFCuttUpp

        Me.LBGFCuttUpBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.CuttUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFCuttUppBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        ...
        Me.LBGFCuttBotBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.CuttBottBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFCuttBotBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        ...
        Me.LBGFSeriBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SeriBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFSeriBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFSeriBal.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFSeriBal.Summary = SumGFSeriBal

        Me.LBGFSabUpTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabUpp", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFSabUpp.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFSabUpp.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFSabUpTd.Summary = SumGFSabUpp

        Me.LBGFSabUpBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.SabUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFSabUppBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFSabUppBal.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFSabUpBal.Summary = SumGFSabUppBal

        Me.LBGFJhtKTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtKomp", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFJhtK.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFJhtK.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFJhtKTd.Summary = SumGFJhtK

        Me.LBGFJhtKBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtKompBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFJhtKBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFJhtKBal.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFJhtKBal.Summary = SumGFJhtKBal

        Me.LBGFJhtTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtUpp", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFJht.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFJht.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFJhtTd.Summary = SumGFJht

        Me.LBGFJhtBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.JhtUppBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFJhtBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFJhtBal.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFJhtBal.Summary = SumGFJhtBal

        Me.LBGFSoleTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.Outsole", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFSole.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFSole.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFSoleTd.Summary = SumGFSole

        Me.LBGFSoleBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.OutsoleBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFSoleBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFSoleBal.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFSoleBal.Summary = SumGFSoleBal

        Me.LBGFAssTd.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.Ass", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFAss.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        SumGFAss.Running = DevExpress.XtraReports.UI.SummaryRunning.Group
        Me.LBGFAssTd.Summary = SumGFAss

        Me.LBGFAssBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.AssBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFAssBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
        ...
        Me.LBGFPackBal.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SPLHProdDtl.PackBal", "{0:#,##0.0;(#,##0.0);""}")})
        SumGFPackBal.FormatString = "{0:#,##0.0;(#,##0.0);""}"
