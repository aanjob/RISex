    ...
    Private Sub TBBarcode_KeyDown(sender As Object, e As KeyEventArgs) Handles TBBarcode.KeyDown
        ...
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                If Me.SLUJam.EditValue = 0 Or IsDBNull(Me.SLUJam.EditValue) Then
                    FcMsgBox("Jam Harus Diisi", "Peringatan", MessageBoxIcon.Warning)
                    Exit Sub
                End If
                ...
                If Cek > 0 Then
                    ...
                    '' ''If CekDt > 0 Then
                    '' ''    Dim cmd1 As New SqlCommand("Select Isnull((Select Sum(Masuk)-Sum(Keluar) From T_StokProses Where Proses='" & Me.SLUProses.EditValue & "' and BOMID='" & strArr(0) & "' and ArtCode='" & strArr(1) & "'),0)", koneksi)
                    ...
                    If CekDt > 0 Then
                        Dim cmd1 As New SqlCommand("Select Isnull((Select Sum(Masuk)-Sum(Keluar)-1 From T_StokProses Where Proses='" & Me.SLUProses.EditValue & "' and BOMID='" & strArr(0) & "' and ArtCode='" & strArr(1) & "'),-1)", koneksi)
                    ...
                    With cmSPD
                        ...
                        .Parameters.Add("@Qty", SqlDbType.Decimal).Value = 1
                        '.Parameters.Add("@Sat", SqlDbType.VarChar).Value = "P"
