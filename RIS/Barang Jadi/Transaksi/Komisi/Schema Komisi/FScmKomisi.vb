...
Public Class FScmKomisi
    ...
    Private Sub FScmKomisi_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        ...
        If MainModule.SlCekScmKomisi(Me.GridView2.GetFocusedDataRow.Item("Tahun")) > 0 Then
            'If MainModule.BackDate = False Then
            XtraMessageBox.Show("Data Tidak Bisa Dihapus Karena Sudah Ada Perhitungan Komisi", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
            'End If
        End If
    ...
    Private Sub GridView1_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            ...
            Me.GridView1.SetRowCellValue(e.RowHandle, "SubJns", "")
    ...
    Private Sub BCopy_Click(sender As Object, e As EventArgs) Handles BCopy.Click
        Dim frm As New FSearch("Skema Komisi", "", "", "", Date.Now, "")
        frm.ShowDialog()

        Try
            If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
                Me.TBTahun.EditValue = dataTrans.Item("Kode").ToString
