...
Public Class FPOBJLkv1
    ...
    Public Sub FillDtl(Kode As String)
        ...
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select POIDD,POID,D.ArtCode,ArtName,Upp,Outs,Variasi,B.AssID,D.SatID,D.Isi,Qty,QtyPol,Psg,PsgPol,HBeli, HCBP,HAkhir,SisaKirim,BtlOrder,BtlProd,(Select Count(*) From T_BOMPO where POID=D.POID and ArtCodeInd=D.ArtCode) As JmlBOM From T_POBJLkDtl D Inner Join M_Brg B On D.ArtCode=B.ArtCode Where POID='" & Kode & "'", koneksi)
    ...
    Private Sub FPOBJLkR_Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Purchase Order Barang Jadi"
    End Sub

    Private Sub FPOBJLkR_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        CekSave = False
    End Sub

    Private Sub FPOBJLkR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LockControl()
        Me.BVTPO_e.Selected = True
    End Sub
        ...
        Select Case Indicator
            Case 100
                ...
                With cmSP
                    ...
                    .Parameters.Add("@TotBayar", SqlDbType.Decimal).Value = Math.Round(CType(Me.GridView1.Columns("HAkhir").SummaryText, Decimal), 2, MidpointRounding.AwayFromZero)
                        ...
                        Dim i : For i = 0 To GridView1.RowCount - 1
                            If Not IsDBNull(Me.GridView1.GetRowCellValue(i, "ArtCode")) Then
                                ...
                                With cmSPDtl
                                    ...
                                    .Parameters.Add("@HBeli", SqlDbType.Decimal).Value = Me.GridView1.GetRowCellValue(i, "HBeli")
                                    .Parameters.Add("@HCBP", SqlDbType.Decimal).Value = Me.GridView1.GetRowCellValue(i, "HCBP")
                                    .Parameters.Add("@HAkhir", SqlDbType.Decimal).Value = Me.GridView1.GetRowCellValue(i, "HAkhir")
                                    .Parameters.Add("@Return", SqlDbType.Int)
                                    .Parameters("@Return").Direction = ParameterDirection.Output
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        ElseIf e.Column Is GridView1.Columns("Qty") Then
            ...
            Me.GridView1.SetRowCellValue(e.RowHandle, "HAkhir", Math.Round((Me.GridView1.GetRowCellValue(e.RowHandle, "Psg") + Me.GridView1.GetRowCellValue(e.RowHandle, "PsgPol")) * Me.GridView1.GetRowCellValue(e.RowHandle, "HBeli"), 4))
        ...
        ElseIf e.Column Is GridView1.Columns("HBeli") Then
            RemoveHandler GridView1.CellValueChanged, AddressOf GridView1_CellValueChanged
    ...
    Private Sub GridView1_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            ...
            Me.GridView1.SetRowCellValue(e.RowHandle, "HBeli", 0)
    ...
    Private Sub FPOBJLkR_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
