...
Public Class XRPOBJLkExt
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        ...
        Me.LBKpdRF.Text = Bind.Item("Kpd").ToString
    ...
    Private Sub XRPOBJLkExt_PrintProgress(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.PrintProgressEventArgs) Handles Me.PrintProgress
        Me.ClosePreview()
    End Sub
End Class