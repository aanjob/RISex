...
Public Class FRtrBJNF_a
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Public Indicator As Int16
    Dim OngkirSatuan As Decimal

    Public Sub New(ByVal JnsCust As String, Gol As String, Grup As String, Gudang As String, Tgl As Date, DocID As String, OngkirSat As Decimal, Manuall As Boolean)
        ...
        If Gol = "Job Order" Or Manuall = True Then
