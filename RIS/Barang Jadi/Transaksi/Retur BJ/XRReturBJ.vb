...
Public Class XRReturBJ
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select D.ArtCode + ' ( ' + B.ArtName + ' )' As Barang, HarSat, Dos, Psg, HarSbDisc, DiscOB,RpDiscL+RpDiscGlb As DiscL,Ongkir, HarAkhir From T_RtrBJDtl D Inner Join M_Brg B On D.ArtCode=B.ArtCode Where RtrID='" & Bind.Item("RtrID").ToString & "'", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_RtrBJDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("Barang", "Barang"), New System.Data.Common.DataColumnMapping("HarSat", "HarSat"), New System.Data.Common.DataColumnMapping("Dos", "Dos"), New System.Data.Common.DataColumnMapping("Psg", "Psg"), New System.Data.Common.DataColumnMapping("HarSbDisc", "HarSbDisc"), New System.Data.Common.DataColumnMapping("DiscOB", "DiscOB"), New System.Data.Common.DataColumnMapping("DiscL", "DiscL")})})
        ...
        Kode = Bind.Item("RtrID").ToString
        Me.LBKode.Text = ": " & Bind.Item("Kode").ToString
        Me.LBReturID.Text = ": " & Bind.Item("RtrID").ToString
       ...
       Me.LBUser.Text = MainModule.LoginAktif
        ...
        Me.LBOB.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.DiscOB", "{0:#,##0.##}")})
        Me.LBDiscL.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.DiscL", "{0:#,##0.##}")})
        Me.LBDos.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.Dos", "{0:#,#0.#}")})
        Me.LBPsg.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.Psg", "{0:#,#0.#}")})
        ...
        Me.LBTotDos.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.Dos", "{0:#,#0.#}")})
        SumDos.FormatString = "{0:#,#0.#}"
        SumDos.Running = DevExpress.XtraReports.UI.SummaryRunning.Page
        Me.LBTotDos.Summary = SumDos

        Me.LBTotPsg.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrBJDtl.Psg", "{0:#,#0.#}")})
        SumPsg.FormatString = "{0:#,#0.#}"
