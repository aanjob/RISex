...
Public Class FRtrBJWF_a
    ...
    Public Sub FillPsg()
        ...
        Dim i : For i = 0 To DsAddDt.Tables("M_BrgAssDtlRt" & Gol).Rows.Count - 1
            Dim comm As New SqlCommand("Select Isnull((Select Sum(Dos) From T_RtrBJDtl Where JualIDD=" & Me.GridView1.GetFocusedDataRow.Item("JualIDD") & " and RtrID<>'" & ReturID & "' and ArtCode<>'" & NoAssD + DsAddDt.Tables("M_BrgAssDtlRt" & Gol).Rows(i).Item("Uk") & "' and SatID<>'P'),0)", koneksi)
            ...
            comm = New SqlCommand("Select Isnull(Sum(Psg),0) From T_RtrBJDtl Where JualIDD=" & Me.GridView1.GetFocusedDataRow.Item("JualIDD") & " and ArtCode='" & NoAssD + DsAddDt.Tables("M_BrgAssDtlRt" & Gol).Rows(i).Item("Uk") & "' And RtrID <>'" & ReturID & "'", koneksi)
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        If e.Column Is GridView1.Columns("QtyRtr") Then
            ...
            Dim comm As New SqlCommand("Select Isnull((Select Sum(Psg) From T_RtrBJDtl Where JualIDD=" & Me.GridView1.GetRowCellValue(e.RowHandle, "JualIDD") & " and RtrID<>'" & ReturID & "'),0)", koneksi)
    ...
    Private Sub GridView2_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView2.CellValueChanged
        ...
        If e.Column Is GridView2.Columns("QtyRtr") Then
            ...
            Dim comm As New SqlCommand("Select Isnull((Select Sum(Dos) From T_RtrBJDtl Where JualIDD=" & Me.GridView2.GetRowCellValue(e.RowHandle, "JualIDD") & " and RtrID<>'" & ReturID & "' and ArtCode<>'" & Me.GridView2.GetRowCellValue(e.RowHandle, "ArtCode") & "' and SatID<>'P'),0)", koneksi)
            ...
            comm = New SqlCommand("Select Isnull((Select Sum(Psg) From T_RtrBJDtl Where JualIDD=" & Me.GridView2.GetRowCellValue(e.RowHandle, "JualIDD") & " and RtrID<>'" & ReturID & "' and ArtCode='" & Me.GridView2.GetRowCellValue(e.RowHandle, "ArtCode") & "'),0)", koneksi)
            ...
            Me.GridView2.SetRowCellValue(e.RowHandle, "RpDiscL", Me.GridView2.GetRowCellValue(e.RowHandle, "QtyRtr") * Me.GridView2.GetRowCellValue(e.RowHandle, "Isi") * DiscL)
