...
Public Class FTrmBJ_a
    ...
    Public Sub New(ByVal JnsDoc As String, Gol As String, Grup As String, TrmID As String)
        ...
        ElseIf JnsDoc = "Lain-Lain" Then
            cmsl = New SqlDataAdapter("Select 0 as DocIDD, '--' As BSTBID,'--' As POID ,ArtCode,ArtName,SatID,Isi,0 As QtyKirim,0 as Qty, 0 As HarSat, 0 As HarAkhir From M_Brg Where Aktif='True' and Gol In ('" & Gol & "','Promosi') and Grup='" & Grup & "'", koneksi)
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        If Jenis <> "Lain-Lain" Then
            If e.Column Is GridView1.Columns("Qty") Then
                ...
                Me.GridView1.SetRowCellValue(e.RowHandle, "HarAkhir", Math.Round(Math.Round(Me.GridView1.GetRowCellValue(e.RowHandle, "Qty"), 2) * Math.Round(Me.GridView1.GetRowCellValue(e.RowHandle, "HarSat"), 2), 2))
            End If
