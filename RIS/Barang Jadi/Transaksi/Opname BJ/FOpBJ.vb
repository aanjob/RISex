...
Public Class FOpBJ
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select convert(bit,'FALSE') as Cek,OpBJIDD,OpBJID,AddDt,D.ArtCode,ArtName,D.SatID,D.Isi,QtyD,DosD,PsgD,QtyF, DosF,PsgF,Selisih,Ket From T_OpBJDtl D Inner Join M_Brg B On D.ArtCode=B.ArtCode Where OpBJID='" & Kode & "' Order By ArtCode Asc", koneksi)
    ...
    Private Sub BandedGridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles BandedGridView1.CellValueChanged
        ...
        ElseIf e.Column Is BandedGridView1.Columns("Selisih") Then
            Me.BandedGridView1.SetRowCellValue(e.RowHandle, "QtyF", Me.BandedGridView1.GetRowCellValue(e.RowHandle, "QtyD") + Me.BandedGridView1.GetRowCellValue(e.RowHandle, "Selisih"))

            If Me.BandedGridView1.GetRowCellValue(e.RowHandle, "QtyF") < 0 Then
                Me.BandedGridView1.SetRowCellValue(e.RowHandle, "Selisih", 0)
                Me.BandedGridView1.SetRowCellValue(e.RowHandle, "QtyF", Me.BandedGridView1.GetRowCellValue(e.RowHandle, "QtyD"))
                XtraMessageBox.Show("Qty Fisik Minus", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        ...
        ElseIf e.Column Is BandedGridView1.Columns("Cek") Then
            If Me.BandedGridView1.GetFocusedRowCellValue("Cek") = True Then
                Me.BandedGridView1.Columns("Selisih").OptionsColumn.AllowEdit = True
                Me.BandedGridView1.Columns("Ket").OptionsColumn.AllowEdit = True

            Else
                Me.BandedGridView1.Columns("Selisih").OptionsColumn.AllowEdit = False
