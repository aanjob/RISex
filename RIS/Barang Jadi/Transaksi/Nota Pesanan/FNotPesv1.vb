...
Public Class FNotPesv1
    ...
    Public Sub HitPPn()
        ...
        ElseIf Me.RBPPn.EditValue = "Include" Then
            ...
            Me.TBTotDPPPst.EditValue = Math.Round(Me.TBTotAkhirPst.EditValue / 1.1, 2, MidpointRounding.AwayFromZero)
            Me.TBTotPPnPst.EditValue = Math.Round(Me.TBTotAkhirPst.EditValue / 1.1 * 10 / 100, 2, MidpointRounding.AwayFromZero)
        ...
        ElseIf Me.RBPPn.EditValue = "Exclude" Then
            ...
            Me.TBTotDPPPst.EditValue = Me.TBTotAkhirPst.EditValue
            Me.TBTotPPnPst.EditValue = Math.Round(Me.TBTotDPPPst.EditValue * 10 / 100, 2, MidpointRounding.AwayFromZero)
    ...
    Private Sub SLUCabang_Leave(sender As Object, e As EventArgs) Handles SLUCab.Leave
        ...
        If Not IsDBNull(Me.SLUCab.EditValue) And Me.SLUCab.EditValue <> "" And Me.SLUCab.EditValue <> "RAP" And Me.SLUCab.EditValue <> "SKB" And Me.SLUCab.EditValue <> "MDN" Then
