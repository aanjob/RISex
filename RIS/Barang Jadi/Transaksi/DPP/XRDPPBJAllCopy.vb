...
Public Class XRDPPBJAllCopy
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select H.DPPBJID,Jenis,H.Kode,H.Tanggal As TglH,C.Nama As Customer,Concat(C.Alamat,CHAR(13),K.Nama) as Alamat,TotTagih,Terbilang, Concat(JualID,' ' ,D.Kode) As JualID,D.Tanggal,DueDate,TotAkhir,Concat(D.TotDos,' Dos ',D.TotPsg,' Psg ',D.Ket) As Ket From T_DPPBJ H Inner Join T_DPPBJDtl D On H.DPPBJID=D.DPPBJID Inner Join M_Cust C On H.CustID=C.CustID Inner Join M_Kota K On C.KotaID=K.KotaID Where H.Tanggal='" & Bind.Item("Tanggal").ToString & "' and H.Gol='" & Bind.Item("Gol").ToString & "'", koneksi)
       ...
       Me.LBUser.Text = MainModule.LoginAktif
        ...
        Me.GroupHeader1.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.LBDPPID})
        Me.GroupHeader1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("DPPBJID", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
