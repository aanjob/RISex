...
Public Class FUser
    ...
    Private Sub LockControl()
        ...
        Me.SLUFormDef.Properties.ReadOnly = True
        Me.SLUProses.Properties.ReadOnly = True
        Me.TBLine.Properties.ReadOnly = True
        Me.TBVersi.Properties.ReadOnly = True
        Me.CESU.Properties.ReadOnly = True
        ...
        Me.CEAlertBmLns.Properties.ReadOnly = True
    ...
    Private Sub OpenControl()
        ...
        Me.SLUFormDef.Properties.ReadOnly = False
        Me.SLUProses.Properties.ReadOnly = False
        Me.TBLine.Properties.ReadOnly = False
        Me.TBVersi.Properties.ReadOnly = False
        Me.CESU.Properties.ReadOnly = False
        ...
        Me.CEAlertBmLns.Properties.ReadOnly = False
    ...
    Public Sub LUE()
        ...
        cmsl = New SqlDataAdapter("Select MenuID From M_Menu Where Menu='True'", koneksi)
        cmsl.TableMappings.Add("Table", "M_MenuL2")
        Try
            DsMaster.Tables("M_MenuL2").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsMaster, "M_MenuL2")

        Me.SLUFormDef.Properties.DataSource = DsMaster.Tables("M_MenuL2")
        Me.SLUFormDef.Properties.DisplayMember = "MenuID"
        Me.SLUFormDef.Properties.ValueMember = "MenuID"

        cmsl = New SqlDataAdapter("Select Proses From M_Proses Where Aktif='True'", koneksi)
        cmsl.TableMappings.Add("Table", "M_ProsesL2")
        Try
            DsMaster.Tables("M_ProsesL2").Clear()
        Catch ex As Exception

        End Try
        cmsl.Fill(DsMaster, "M_ProsesL2")

        Me.SLUProses.Properties.DataSource = DsMaster.Tables("M_ProsesL2")
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select UserID,[dbo].[fcDecrypt](LoginID) as LoginID,Nama,Inisial,[dbo].[fcDecrypt](Passwordd) as Passwordd, PosisiID,DvcID,Versi,Proses,Line,GdID,FormDef,SU,NoHarga,Alert,AlertJual,AlertApp,AlertReqC,AlertSpec,AlertBOM,AlertPO,AlertSampR,AlertPass,AlertBSTB,AlertCair, AlertBOMstsPO,AlertTrmPO,AlertSJKBB,AlertBayar,AlertBlmLns,BackDate,Aktif,InsDate,InsBy,UpdDate,UpdBy From M_User Order By Nama Asc", koneksi)
    ...
    Private Sub BVBNew_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBNew.ItemClick
        ...
        Me.CEAlertBmLns.EditValue = False
        ...
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select Distinct 0 As HubID,0 As UserID,'' As NamaLogin,Grup From M_UsGrup", koneksi)
        ...
        cmsl = New SqlDataAdapter("Select Distinct 0 As HubID,0 as UserID,'' As NamaLogin,UC.CabID,Case When UC.CabID='%' Then 'Semua' Else C.Cabang End As Cabang,0 As Def From M_UsCab UC Left Outer Join M_Cab C On UC.CabID=C.CabID", koneksi)
        ...
        cmsl = New SqlDataAdapter("Select Distinct 0 As HubID,0 as UserID,'' As NamaLogin,Case When Proses='%' Then 'Semua' Else Proses End As Proses From M_UsProses", koneksi)
        cmsl.TableMappings.Add("Table", "M_UsProses")
        Try
            DsMaster.Tables("M_UsProses").Clear()
        Catch ex As Exception

        End Try

        cmsl.Fill(DsMaster, "M_UsProses")

        Me.GridControl4.DataSource = DsMaster
        Me.GridControl4.DataMember = "M_UsProses"
    End Sub
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        LUE()
        Indicator = "200"
        UserID = Me.BandedGridView1.GetFocusedDataRow.Item("UserID")
        Me.TBLogin.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("LoginID")
        Me.TBNama.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Nama")
        Me.TBInisial.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Inisial")
        Me.TBPassword.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Passwordd")
        Me.SLUPosisi.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("PosisiID")
        Me.SLUFormDef.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("FormDef")
        Me.SLUProses.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Proses")
        Me.TBLine.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Line")
        Me.TBDeviceID.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("DvcID")
        Me.TBVersi.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Versi")
        Me.CESU.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("SU")
        Me.CENoHarga.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("NoHarga")
        Me.CEAlertPemb.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Alert")
        Me.CEAlertJual.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertJual")
        Me.CEAlertApp.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertApp")
        Me.CEAlertReqC.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertReqC")
        Me.CEAlertSpec.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertSpec")
        Me.CEAlertBOM.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertBOM")
        Me.CEAlertPO.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertPO")
        Me.CEAlertSampR.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertSampR")
        Me.CEAlertPass.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertPass")
        Me.CEAlertBSTB.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertBSTB")
        Me.CEAlertCair.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertCair")
        Me.CEAlertBOMstsPO.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertBOMstsPO")
        Me.CEAlertTrmPO.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertTrmPO")
        Me.CEAlertSJKBB.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertSJKBB")
        Me.CEAlertBayar.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertBayar")
        Me.CEAlertBmLns.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("AlertBlmLns")
        Me.CEBackDate.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("BackDate")
        Me.CEAktif.EditValue = Me.BandedGridView1.GetFocusedDataRow.Item("Aktif")
        ...
        cmsl = New SqlDataAdapter("Select HubID,UserID,NamaLogin,Case When Proses='%' Then 'Semua' Else Proses End As Proses From M_UsProses Where UserID=" & UserID & "", koneksi)
        cmsl.TableMappings.Add("Table", "M_UsProses")
        Try
            DsMaster.Tables("M_UsProses").Clear()
        Catch ex As Exception
    ...
    Private Sub BVBResetPassword_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBReset.ItemClick
        ...
        If XtraMessageBox.Show("Apakah Anda Mau Mereset Password : " & Me.BandedGridView1.GetFocusedDataRow.Item("Nama") & " Ini ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            Dim cmSP As New SqlCommand("SPResetM_User")
            cmSP.CommandType = CommandType.StoredProcedure
            Dim x As Integer

            With cmSP
                .Parameters.Add("@UserID", SqlDbType.Int).Value = Me.BandedGridView1.GetFocusedDataRow.Item("UserID")
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        ...
        If XtraMessageBox.Show("Apakah Anda Mau Menghapus User : " & Me.BandedGridView1.GetFocusedDataRow.Item("Nama") & " Ini ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
        ...
        Select Case Indicator
            Case 100
                ...
                With cmSP
                    ...
                    .Parameters.Add("@GdID", SqlDbType.VarChar).Value = ""
                    .Parameters.Add("@Proses", SqlDbType.VarChar).Value = Me.SLUProses.EditValue
                    .Parameters.Add("@Line", SqlDbType.VarChar).Value = Me.TBLine.EditValue
                    .Parameters.Add("@FormDef", SqlDbType.VarChar).Value = Me.SLUFormDef.EditValue
                    .Parameters.Add("@Versi", SqlDbType.VarChar).Value = Me.TBVersi.EditValue
                    .Parameters.Add("@SU", SqlDbType.Bit).Value = Me.CESU.EditValue
                    ...
                    .Parameters.Add("@AlertBlmLns", SqlDbType.Bit).Value = Me.CEAlertBmLns.EditValue
                    ...
                    Try
                        ...
                        Dim q : For q = 0 To GridView4.RowCount - 1
                            Dim cmSPDtl As New SqlCommand("SPInsM_UsProses")
                            cmSPDtl.CommandType = CommandType.StoredProcedure

                            With cmSPDtl
                                .Parameters.Add("@UserID", SqlDbType.Int).Value = UserID
                                .Parameters.Add("@Nama", SqlDbType.VarChar).Value = Me.TBNama.EditValue
                                .Parameters.Add("@Proses", SqlDbType.VarChar).Value = Me.GridView4.GetRowCellValue(q, "Proses")
                                .Parameters.Add("@Return", SqlDbType.Int)
                                .Parameters("@Return").Direction = ParameterDirection.Output
                                .Connection = koneksi
                            End With
                    ...
                    Try
                        ...
                        Dim i : For i = 0 To GridView2.RowCount - 1
                            If Me.GridView2.GetRowCellValue(i, "HubID") < 0 Then
                                ...
                                If x = 0 Then
                                    Me.BandedGridView1.SetRowCellValue(i, "HubID", Me.GridView2.GetRowCellValue(i, "HubID") * -1)
                                End If
                        ...
                        Dim q : For q = 0 To GridView4.RowCount - 1
                            If Me.GridView4.GetRowCellValue(q, "HubID") < 0 Then
                                Dim cmSPDtl As New SqlCommand("SPInsM_UsProses")
                                cmSPDtl.CommandType = CommandType.StoredProcedure
                                ...
                                If x = 0 Then
                                    Me.GridView4.SetRowCellValue(q, "HubID", Me.GridView4.GetRowCellValue(q, "HubID") * -1)
                                End If

                            Else
                                Dim cmSPDtl As New SqlCommand("SPUpM_UsProses")
                                cmSPDtl.CommandType = CommandType.StoredProcedure

                                With cmSPDtl
                                    .Parameters.Add("@Id", SqlDbType.Int).Value = Me.GridView4.GetRowCellValue(q, "HubID")
                                    .Parameters.Add("@UserID", SqlDbType.Int).Value = UserID
                                    .Parameters.Add("@Nama", SqlDbType.VarChar).Value = Me.TBNama.EditValue
                                    .Parameters.Add("@Proses", SqlDbType.VarChar).Value = Me.GridView4.GetRowCellValue(q, "Proses")
                                    .Parameters.Add("@Return", SqlDbType.Int)
    ...
    Private Sub GridControl4_EmbeddedNavigator_ButtonClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs) Handles GridControl4.EmbeddedNavigator.ButtonClick
        If (e.Button.ButtonType = NavigatorButtonType.Remove) Then
            ...
            arrPar3(arrPar3.GetUpperBound(0)) = Me.GridView4.GetFocusedDataRow.Item("HubID")
        End If
    End Sub
    ...
    Private Sub GridView4_InitNewRow(sender As Object, e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView4.InitNewRow
        Try
            ...
            Me.GridView4.SetRowCellValue(e.RowHandle, "Proses", "")
        Catch ex As Exception
    ...
    Private Sub BEdCabID_KeyPress(sender As Object, e As KeyPressEventArgs) Handles BEdCabID.KeyPress
        e.Handled = True
    End Sub

    Private Sub BEdProses_ButtonClick(sender As Object, e As Controls.ButtonPressedEventArgs) Handles BEdProses.ButtonClick
        Try
            Dim frm As New FSearch("Proses", "", "", "", Date.Now, "")
            frm.ShowDialog()
