...
Public Class FQCBahan_d
    Dim koneksi As New SqlConnection(GlobalKoneksi)

    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select QCIDD,QCID,BBID,Sat,Qty,CaraUji,Ket,Kesimpulan,KetKesimpulan From T_QCBahanDtl Where QCID='" & Kode & "'", koneksi)
    ...
    Private Sub FQCBahan_d_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.GridView1.Focus()
    End Sub
