...
Public Class FAdjBB
    ...
    Private Sub GridView2_DoubleClick(sender As Object, e As EventArgs) Handles GridView2.DoubleClick
        Try
            Dim frm As New FAdjBB_d(Me.GridView2.GetFocusedDataRow.Item("AdjBBID"))
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
