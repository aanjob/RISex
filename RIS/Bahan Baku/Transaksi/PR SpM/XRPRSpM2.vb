...
Public Class XRPRSpM2
    ...
    Public Sub InitializeData(ByVal Bind As Collection, Jenis As String, Gol As String)
        ...
        cmsl = New SqlDataAdapter("Select B.Nama as Bahan,D.Sat,Qty,D.Ket From T_PRSpMDtl D Inner Join M_BB B On D.BBID=B.BBID Where PRSMID ='" & Bind.Item("Kode").ToString & "'", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_PRSpMDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("Qty", "Qty"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("Ket", "Ket")})})
