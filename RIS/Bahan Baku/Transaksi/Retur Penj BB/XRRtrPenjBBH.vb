...
Public Class XRRtrPenjBBH
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select BtNum,B.Nama As Bahan,Qty,D.Sat,HarSat,HarSbDisc,HarSbDisc/1.1 As HarSbDiscInclude From T_RtrPenjBB H Inner Join T_RtrPenjBBDtl D On H.RtrID=D.RtrID Inner Join M_BB B On D.BBID=B.BBID Where H.RtrID ='" & Bind.Item("Kode").ToString & "'", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_RtrPenjBBDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("BtNum", "BtNum"), New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("Qty", "Qty"), New System.Data.Common.DataColumnMapping("HarSat", "HarSat"), New System.Data.Common.DataColumnMapping("HarSbDisc", "HarSbDisc")})})
        ...
        Me.LBBtNum.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrPenjBBDtl.BtNum")})
        ...
        Me.LBHarSat.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrPenjBBDtl.HarSat", "{0:#,##0.#####}")})
        Me.LBJml.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrPenjBBDtl.HarSbDisc", "{0:#,##0.#####}")})

        If Bind.Item("TipePPn").ToString = "Include" Then
            Me.LBSubTot.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrPenjBBDtl.HarSbDiscInclude", "{0:n2}")})
        Else
            Me.LBSubTot.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RtrPenjBBDtl.HarSbDisc", "{0:n2}")})
        End If
