...
Public Class XRRtrPenjBBHv1
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select B.Nama As Bahan,Qty,D.Sat,HarSat,HarSbDisc,HarSbDisc/1.1 As HarSbDiscInclude From T_RtrPenjBB H Inner Join T_RtrPenjBBDtl D On H.RtrID=D.RtrID Inner Join M_BB B On D.BBID=B.BBID Where H.RtrID ='" & Bind.Item("Kode").ToString & "'", koneksi)
