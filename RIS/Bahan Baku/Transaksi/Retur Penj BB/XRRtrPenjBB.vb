...
Public Class XRRtrPenjBB
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter

    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select BtNum,B.Nama As Bahan,Qty,D.Sat From T_RtrPenjBB H Inner Join T_RtrPenjBBDtl D On H.RtrID=D.RtrID Inner Join M_BB B On D.BBID=B.BBID Where H.RtrID ='" & Bind.Item("Kode").ToString & "'", koneksi)
