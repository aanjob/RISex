...
Public Class FRtrPenjBB
    ...
    Public Sub LUE()
        ...
        cmsl = New SqlDataAdapter("Select JualID,SOID,H.CustID,C.Nama As Cust,MtUang,stsPPn,TipePPn,PersenPPn,DiscP,Round(DiscRp/TotQty,4) As DiscRpSat From T_JualBB H Inner Join M_cust C On H.CustID=C.CustID Where stsLunas='False' and Gol='" & Gol & "'", koneksi)
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select RtrIDD,RtrID,JualIDD,D.BBID,BtNum,B.Nama as Bahan,D.Sat,Qty,HarSat,HarSbDisc,DiscRpSat,DiscRp,DiscP,RpDiscP, HarAkhir From T_RtrPenjBBDtl D Inner Join M_BB B On D.BBID=B.BBID Where RtrID='" & Kode & "'", koneksi)
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select RtrID,PeriodID,CodeID,Tanggal,H.Gol,H.CustID,C.Nama as Customer,C.Alamat,K.Nama As Kota,JualID,H.GdID, G.Nama as Gudang,CurrID,MtUang, NilTukarRp,TipePPn,PersenPPn,TotQty,TotSbDisc,DiscP,RpDiscP,DiscRpSat,DiscRp,TotDisc,TotDPP,TotPPn, TotAkhir, SisaPakai,H.Ket,stsPPn,stsPakai,H.InsDate,H.InsBy,H.UpdDate,H.UpdBy,(Select Count(*) From (Select (Select Sum(Masuk)-Sum(Keluar) From T_StokBB where DocID<>T_RtrPenjBBDtl.RtrID and BBID=T_RtrPenjBBDtl.BBID and BtNum=T_RtrPenjBBDtl.BtNum) As stok,* From T_RtrPenjBBDtl where RtrID=H.RtrID) as x where stok <0) as Cek From T_RtrPenjBB H Inner Join M_Gudang G On H.GdID=G.GdID Inner Join M_Cust C On H.CustID=C.CustID Inner Join M_Kota K On C.KotaID=K.KotaID Where PeriodID=" & MainModule.periodAktif & " and H.Gol ='" & Gol & "' Order By Tanggal,RtrID asc", koneksi)
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Dim cmd2 As New SqlCommand("SPAftSRtrPenjBB")
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        If e.Column Is GridView1.Columns("Qty") Then
            ...
            'command2 = New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "RtrIDD") & ",'" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNum") & "')", koneksi)
            ...
            'If Me.GridView1.GetRowCellValue(e.RowHandle, "Qty") + Stok < 0 Then
            '    XtraMessageBox.Show("Qty Menjadi Minus", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
    ...
    Private Sub GridView2_DoubleClick(sender As Object, e As EventArgs) Handles GridView2.DoubleClick
        Try
            Dim frm As New FRtrPenjBB_d(Me.GridView2.GetFocusedDataRow.Item("RtrID"))
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
    ...
    Private Sub SLUFtID_Leave(sender As Object, e As EventArgs) Handles SLUFtID.Leave
        If Not IsDBNull(Me.SLUFtID.EditValue) And Me.SLUFtID.Properties.ReadOnly = False Then
            Try
                ...
                Me.TBPersenPPn.EditValue = DsMaster.Tables("T_JualBBRtr").Select("JualID = '" & Me.SLUFtID.EditValue & "'")(0).Item("PersenPPn")
                stsPPn = DsMaster.Tables("T_JualBBRtr").Select("JualID = '" & Me.SLUFtID.EditValue & "'")(0).Item("stsPPn")
                Me.SLUMtUang.EditValue = DsMaster.Tables("T_JualBBRtr").Select("JualID = '" & Me.SLUFtID.EditValue & "'")(0).Item("MtUang")
