...
Public Class XRTAG
    ...
    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select D.BBID,BtNum,Nama As Bahan,D.Sat,Qty,D.Ket From T_TAGDtl D Inner Join M_BB B On D.BBID=B.BBID Where TAGID='" & Bind.Item("Kode").ToString & "'", koneksi)
        ...
        Me.LBBtNum.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_TAGDtl.BtNum")})
