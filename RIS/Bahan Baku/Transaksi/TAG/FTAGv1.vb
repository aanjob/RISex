...
Public Class FTAGv1
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        ...
        If Manual = False Then
            ...
            Dim i : For i = Me.GridView1.RowCount - 1 To 0 Step -1
                ...
                Dim command As New SqlCommand("Select dbo.fcStokBBAll('" & Me.GridView1.GetRowCellValue(i, "BBID") & "','" & Me.GridView2.GetFocusedDataRow.Item("GdIDTj") & "','" & Me.GridView2.GetFocusedDataRow.Item("TAGID") & "'," & Me.GridView1.GetRowCellValue(i, "TAGIDD") & ")", koneksi)
        ...
        If Me.SLUGdAs.Properties.ReadOnly = False Then
            ...
            If Me.SLUGdAs.EditValue <> "" And Not IsDBNull(Me.SLUGdAs.EditValue) And Me.SLUGdAs.Properties.ReadOnly = False Then
                Dim i : For i = 0 To Me.GridView1.RowCount - 1
                    ...
                    Dim command As New SqlCommand("Select dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(i, "BBID") & "','" & Me.SLUGdAs.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "')", koneksi)
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        If e.Column Is GridView1.Columns("Qty") Then
            If Manual = False Then
                ...
                command = New SqlCommand("Select dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGdAs.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "')", koneksi)
                ...
                command2 = New SqlCommand("Select dbo.fcStokBBAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGdAs.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TAGIDD") & ")", koneksi)
            ...
            If Me.GridView1.RowCount - 1 > 0 Then
                If Not IsDBNull(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID")) Then
                    If Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID") <> "" Then
                        ...
                        Dim commandx As New SqlCommand("Select dbo.fcStokBBAll('" & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID") & "','" & Me.SLUGdTj.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TAGIDD") & ")", koneksi)
    ...
    Private Sub GridView2_DoubleClick(sender As Object, e As EventArgs) Handles GridView2.DoubleClick
        Try
            Dim frm As New FTAG_dv1(Me.GridView2.GetFocusedDataRow.Item("TAGID"), Me.GridView2.GetFocusedDataRow.Item("GdIDAs"), Manual)
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
