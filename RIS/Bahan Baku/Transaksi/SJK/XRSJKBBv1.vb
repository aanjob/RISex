...
Public Class XRSJKBBv1
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter

    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select (Select isnull((Select BOMID From T_SOBBDtl Where SOIDD=D.DocIDD and SOID=H.DocID),'')) As BOMID,B.Nama as Bahan,D.Sat,Qty From T_SJKBB H Inner Join T_SJKBBDtl D On H.SJKID=D.SJKID Inner Join M_BB B On D.BBID=B.BBID Where H.SJKID ='" & Bind.Item("Kode").ToString & "'", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_SJKBBDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("Qty", "Qty")})})
