...
Public Class FOpBBv2
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select OpBBIDD,OpBBID,AddDt,J.Nama As Jenis,D.BBID,BtNum,B.Nama As Bahan,D.Sat,QtyD,SalD,QtyF,SalF,SelisihQty, SelisihSal,HarSat, HarSatAs,D.Ket From T_OpBBDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_BBJns J On B.JnsID=J.JnsID Where OpBBID='" & Kode & "'", koneksi)
