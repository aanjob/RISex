...
Public Class FOpBB
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select convert(bit,'FALSE') as Cek,OpBBIDD,OpBBID,AddDt,J.Nama As Jenis,D.BBID,BtNum,B.Nama As Bahan,D.Sat,QtyD,SalD,QtyF,SalF,SelisihQty, SelisihSal,HarSat, HarSatAs,D.Ket From T_OpBBDtl D Inner Join M_BB B On D.BBID=B.BBID Inner Join M_BBJns J On B.JnsID=J.JnsID Where OpBBID='" & Kode & "'", koneksi)
        ...
        DsMaster.Tables("T_OpBBDtl").PrimaryKey = New DataColumn() {DsMaster.Tables("T_OpBBDtl").Columns("BBID"), DsMaster.Tables("T_OpBBDtl").Columns("BtNum")}
    ...
    Private Sub BVBNew_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBNew.ItemClick
        ...
        Me.BandedGridColumn8.Visible = False
    End Sub
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        If Me.BandedGridView2.GetFocusedDataRow.Item("Terproses") = False Then
            ...
            Me.BandedGridColumn8.VisibleIndex = 0
                        ...
                        Dim i : For i = 0 To BandedGridView1.RowCount - 1
                            If Not IsDBNull(Me.BandedGridView1.GetRowCellValue(i, "BBID")) Then
                                ...
                                With cmSPDtl
                                    ...
                                    .Parameters.Add("@BtNum", SqlDbType.VarChar).Value = Me.BandedGridView1.GetRowCellValue(i, "BtNum")
            ...
            Case 200
                ...
                With cmSP
                    ...
                    Try
                        ...
                        Me.BandedGridView1.ActiveFilterString = "[Cek] = True"
    ...
    Private Sub BandedGridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles BandedGridView1.CellValueChanged
        ...
        ElseIf e.Column Is BandedGridView1.Columns("SelisihQty") Then
            Me.BandedGridView1.SetRowCellValue(e.RowHandle, "QtyF", Me.BandedGridView1.GetRowCellValue(e.RowHandle, "QtyD") + Me.BandedGridView1.GetRowCellValue(e.RowHandle, "SelisihQty"))
        ...
        ElseIf e.Column Is BandedGridView1.Columns("Cek") Then
            If Me.BandedGridView1.GetFocusedRowCellValue("Cek") = True Then
                Me.BandedGridView1.Columns("SelisihQty").OptionsColumn.AllowEdit = True
                Me.BandedGridView1.Columns("SelisihSal").OptionsColumn.AllowEdit = True
                Me.BandedGridView1.Columns("HarSat").OptionsColumn.AllowEdit = True
                Me.BandedGridView1.Columns("Ket").OptionsColumn.AllowEdit = True

            Else
                Me.BandedGridView1.Columns("SelisihQty").OptionsColumn.AllowEdit = False
                Me.BandedGridView1.Columns("SelisihSal").OptionsColumn.AllowEdit = False
                Me.BandedGridView1.Columns("HarSat").OptionsColumn.AllowEdit = False
                Me.BandedGridView1.Columns("Ket").OptionsColumn.AllowEdit = False
            End If
        End If
    End Sub
            ...
            If Me.BandedGridView1.GetFocusedDataRow.Item("AddDt") = True Then
                ...
                Try
                    If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
                        Me.BandedGridView1.SetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "Cek", True)
                        Me.BandedGridView1.SetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "BBID", dataTrans.Item("Kode").ToString)
                        Me.BandedGridView1.SetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "BtNum", "")
    ...
    Private Sub BandedGridView1_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles BandedGridView1.InitNewRow
        ...
        If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
            Me.BandedGridView1.SetRowCellValue(e.RowHandle, "Cek", True)
            ...
            Me.BandedGridView1.SetRowCellValue(e.RowHandle, "BtNum", "")
            ...
            Me.BandedGridView1.Columns("BtNum").OptionsColumn.AllowEdit = True
    ...
    Private Sub BandedGridView2_DoubleClick(sender As Object, e As EventArgs) Handles BandedGridView2.DoubleClick
        Try
            Dim frm As New FOpBB_d(Me.BandedGridView2.GetFocusedDataRow.Item("OpBBID"))
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
    ...
    Private Sub BandedGridView1_ValidateRow(sender As Object, e As DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs) Handles BandedGridView1.ValidateRow
        Dim View As GridView = CType(sender, GridView)
        Dim BtNumCol As GridColumn = View.Columns("BtNum")
        Dim QtyF As GridColumn = View.Columns("QtyF")

        If (Me.BandedGridView1.GetRowCellValue(e.RowHandle, "SelisihQty") Or Me.BandedGridView1.GetRowCellValue(e.RowHandle, "SelisihSal") > 0) > 0 And Me.BandedGridView1.GetRowCellValue(e.RowHandle, "BtNum") = "" Then
            e.Valid = False
            View.SetColumnError(BtNumCol, "Batch Number Harus Diisi")
        End If

        If Me.BandedGridView1.GetRowCellValue(e.RowHandle, "SelisihQty") <> 0 And Me.BandedGridView1.GetRowCellValue(e.RowHandle, "QtyF") < 0 Then
            View.SetColumnError(QtyF, "Qty Fisik Minus")
        End If

    End Sub

    Private Sub BandedGridView1_FocusedRowChanged(sender As Object, e As Views.Base.FocusedRowChangedEventArgs) Handles BandedGridView1.FocusedRowChanged
        If Me.BandedGridView1.Editable = True Then
            If Me.BandedGridView1.RowCount > 0 Then
                If Not IsDBNull(Me.BandedGridView1.GetFocusedRowCellValue("AddDt")) Then
                    If Me.BandedGridView1.GetFocusedRowCellValue("AddDt") = True Then
                        Me.BandedGridView1.Columns("BtNum").OptionsColumn.AllowEdit = True
                    Else
                        Me.BandedGridView1.Columns("BtNum").OptionsColumn.AllowEdit = False
                    End If
                End If
            End If
        End If

        If Indicator = 200 Then
            If Not IsDBNull(Me.BandedGridView1.GetFocusedRowCellValue("Cek")) Then
                If Me.BandedGridView1.GetFocusedRowCellValue("Cek") = True Then
                    Me.BandedGridView1.Columns("SelisihQty").OptionsColumn.AllowEdit = True
                    Me.BandedGridView1.Columns("SelisihSal").OptionsColumn.AllowEdit = True
                    Me.BandedGridView1.Columns("HarSat").OptionsColumn.AllowEdit = True
