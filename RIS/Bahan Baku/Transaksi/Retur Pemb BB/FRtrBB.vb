...
Public Class FRtrBB
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select RtrIDD,RtrID,TrmIDD,TrmID,POIDD,BOMID,D.BBID,BtNum,B.Nama as Bahan,D.Sat,Qty,HarSat,HarSbDisc,DiscRpSat, DiscRp,DiscP,RpDiscP,HarAkhir,HarSatDPP,HarBahan From T_RtrBBDtl D Inner Join M_BB B On D.BBID=B.BBID Where RtrID='" & Kode & "'", koneksi)
        ...
        DsMaster.Tables("T_RtrBBDtl").PrimaryKey = New DataColumn() {DsMaster.Tables("T_RtrBBDtl").Columns("TrmIDD"), DsMaster.Tables("T_RtrBBDtl").Columns("POIDD"), DsMaster.Tables("T_RtrBBDtl").Columns("BBID"), DsMaster.Tables("T_RtrBBDtl").Columns("BtNum")}
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select RtrID,PeriodID,CodeID,Tanggal,Jenis,H.Gol,Kat,H.SuppID,S.Nama as Supplier,S.Alamat,K.Nama As Kota,POID, H.GdID,G.Nama as Gudang,SJ,CurrID,MtUang,NilTukarRp,TipePPn,PersenPPn,TotQty,TotSbDisc,DiscP,RpDiscP,DiscRpSat,DiscRp,TotDisc,TotDPP, TotPPn,TotAkhir,H.Ket,H.stsNonPT,stsPPn,stsNotaRtr,H.InsDate,H.InsBy,H.UpdDate,H.UpdBy From T_RtrBB H Inner Join M_Gudang G On H.GdID=G.GdID Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Where PeriodID=" & MainModule.periodAktif & " and H.Gol ='" & Gol & "' Order By Tanggal,RtrID asc", koneksi)
    ...
    Public Sub DelXml()
        If IO.File.Exists("SrBBNBOMBtNum" & Gol & ".xml") Then
            System.IO.File.Delete("SrBBNBOMBtNum" & Gol & ".xml")
        End If
    End Sub
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        ...
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select POID,DueDate,TipePPn,PersenPPn,stsQC,stsPPn,MtUang,DiscP,Round(DiscRp/TotQty,4) As DiscRpSat From T_POBB Where SuppID='" & Me.SLUSupp.EditValue & "' and stsKirim='False' and stsBatal='False' and Gol='" & Gol & "' or POID In (Select POID From T_RtrBB where RtrID ='" & Me.TBKode.EditValue & "')", koneksi)
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        ...
        If Manual = False Then
            ...
            Dim i : For i = Me.GridView1.RowCount - 1 To 0 Step -1
                ...
                Dim command As New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(i, "BBID") & "','" & Me.GridView2.GetFocusedDataRow.Item("GdID") & "','" & Me.GridView2.GetFocusedDataRow.Item("RtrID") & "'," & Me.GridView1.GetRowCellValue(i, "RtrIDD") & ",'" & Me.GridView1.GetRowCellValue(i, "BtNum") & "')", koneksi)
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Dim cmd2 As New SqlCommand("SPAftSRtrPembBB")
    ...
    Private Sub BEdBBID_ButtonClick(sender As Object, e As Controls.ButtonPressedEventArgs) Handles BEdBBID.ButtonClick
        Try
            Dim frm As New FSearch("BB No BOM BtNum", Me.SLUSupp.EditValue, Gol, "", Date.Now, "")
            frm.ShowDialog()
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        If e.Column Is GridView1.Columns("Qty") Then
            ...
            If Me.CBOJenis.EditValue = "With LPB" Then
                command = New SqlCommand("Select Case When (Select Qty -(Select Isnull((Select Sum(Qty) From T_RtrBBDtl Where TrmIDD=" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmIDD") & " and RtrID<>'" & Me.TBKode.EditValue & "'),0)) From T_TrmBBDtl Where TrmID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmID") & "' And TrmIDD=" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmIDD") & ") > dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNum") & "') Then dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNum") & "') Else (Select Qty -(Select Isnull((Select Sum(Qty) From T_RtrBBDtl Where TrmIDD=" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmIDD") & " and RtrID<>'" & Me.TBKode.EditValue & "'),0)) From T_TrmBBDtl Where TrmID='" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmID") & "' And TrmIDD=" & Me.GridView1.GetRowCellValue(e.RowHandle, "TrmIDD") & ") End As Qty ", koneksi)
                ...
                If Me.GridView1.GetRowCellValue(e.RowHandle, "Qty") > Stok1 Then
                    XtraMessageBox.Show("Qty Tidak Boleh Melebihi Penerimaan/Stok", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            ...
            command2 = New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(e.RowHandle, "RtrIDD") & ",'" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNum") & "')", koneksi)
            ...
            Dim command3 As New SqlCommand("Select dbo.fcStokBBAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "RtrIDD") & ")", koneksi)
            ...
            If Me.GridView1.RowCount - 1 > 0 Then
                If Not IsDBNull(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID")) Then
                    If Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID") <> "" Then
                        ...
                        Dim commandx As New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "RtrIDD") & ",'" & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BtNum") & "')", koneksi)
    ...
    Private Sub GridView2_DoubleClick(sender As Object, e As EventArgs) Handles GridView2.DoubleClick
        Try
            Dim frm As New FRtrBB_d(Me.GridView2.GetFocusedDataRow.Item("RtrID"))
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
    ...
    Private Sub SLUSupp_Leave(sender As Object, e As EventArgs) Handles SLUSupp.Leave
        If Not IsDBNull(Me.SLUSupp.EditValue) And Me.SLUSupp.Properties.ReadOnly = False Then
            Try
                ...
                cmsl = New SqlDataAdapter("Select POID,DueDate,TipePPn,PersenPPn,stsQC,stsPPn,stsNonPT,MtUang,DiscP,Round(DiscRp/TotQty,4) As DiscRpSat From T_POBB Where SuppID='" & Me.SLUSupp.EditValue & "' and POID In (Select POID From T_TrmBB where Year(Tanggal) >= " & MainModule.periodeTahun - 5 & ") and Gol='" & Gol & "'", koneksi)
                cmsl.TableMappings.Add("Table", "T_POBBRtr" & Gol)
                cmsl.Fill(DsMaster, "T_POBBRtr" & Gol)
                DsMaster.Tables("T_POBBRtr" & Gol).Clear()
                cmsl.Fill(DsMaster, "T_POBBRtr" & Gol)
    ...
    Private Sub SLUPOID_Leave(sender As Object, e As EventArgs) Handles SLUPOID.Leave
        If Not IsDBNull(Me.SLUPOID.EditValue) And Me.SLUPOID.Properties.ReadOnly = False Then
            Try
                ...
                Me.TBPersenPPn.EditValue = DsMaster.Tables("T_POBBRtr" & Gol).Select("POID = '" & Me.SLUPOID.EditValue & "'")(0).Item("PersenPPn")
                ...
                stsNonPT = DsMaster.Tables("T_POBBRtr" & Gol).Select("POID = '" & Me.SLUPOID.EditValue & "'")(0).Item("stsNonPT")

                CekCurr()

                Dim cmsl As SqlDataAdapter
                cmsl = New SqlDataAdapter("Select *,Round(DiscRpSat*Qty,4) As DiscRp,Qty*HarSat As HarSbDisc,((Qty*HarSat)*DiscP)/100 As RpDiscP,(Qty*HarSat)-(((Qty*HarSat)*DiscP)/100)-(Qty*DiscRpSat) as HarAkhir From (Select ROW_NUMBER() over (ORDER BY D.BBID)*-1 as RtrIDD, H.TrmID,TrmIDD,POIDD,BOMID,'" & InisialBC & "'+D.BBID As BBID,BtNum,B.Nama As Bahan,D.Sat,0 As Qty,HarSat,D.DiscP,Round(D.DiscRp/Qty,4) As DiscRpSat From T_TrmBB H Inner Join T_TrmBBDtl D On H.TrmID=D.TrmID Inner Join M_BB B On D.BBID=B.BBID Where POID='" & Me.SLUPOID.EditValue & "') As x Order By TrmID,Bahan asc", koneksi)
    ...
    Private Sub DTPTanggal_Leave(sender As Object, e As EventArgs) Handles DTPTanggal.Leave
        ...
        Dim i : For i = 0 To Me.GridView1.RowCount - 1
            If Me.CBOJenis.EditValue = "With LPB" Then
                Dim command As New SqlCommand("Select Case When (Select Qty -(Select Isnull((Select Sum(Qty) From T_RtrBBDtl Where TrmIDD=" & Me.GridView1.GetRowCellValue(i, "TrmIDD") & " and RtrID<>'" & Me.TBKode.EditValue & "'),0)) From T_TrmBBDtl Where TrmID='" & Me.GridView1.GetRowCellValue(i, "TrmID") & "' And TrmIDD=" & Me.GridView1.GetRowCellValue(i, "TrmIDD") & ") > dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(i, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(i, "BtNum") & "') Then dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(i, "BBID") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(i, "BtNum") & "') Else (Select Qty -(Select Isnull((Select Sum(Qty) From T_RtrBBDtl Where TrmIDD=" & Me.GridView1.GetRowCellValue(i, "TrmIDD") & " and RtrID<>'" & Me.TBKode.EditValue & "'),0)) From T_TrmBBDtl Where TrmID='" & Me.GridView1.GetRowCellValue(i, "TrmID") & "' And TrmIDD=" & Me.GridView1.GetRowCellValue(i, "TrmIDD") & ") End As Qty ", koneksi)
                ...
                If Me.GridView1.GetRowCellValue(i, "Qty") > Stok Then
                    XtraMessageBox.Show("Qty ID Bahan : " & Me.GridView1.GetRowCellValue(i, "BBID") & " Melebihi Penerimaan", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
