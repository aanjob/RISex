...
Public Class XRRtrPembBBv1
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter

    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select B.Nama As Bahan,TD.Sat,Sum(Qty) As Qty,HarSat From T_RtrBBDtl TD Inner Join M_BB B On TD.BBID=B.BBID Where RtrID ='" & Bind.Item("Kode").ToString & "' Group By B.Nama,TD.Sat,HarSat", koneksi)
