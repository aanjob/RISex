...
Public Class FMetodeByr
    ...
    Public Sub New()
        ...
        Dim command As New SqlCommand("Select Distinct Manuall,CodeID,MnlInsUpd From M_DocCode Where DocID=38", koneksi)
    ...
    Private Sub LockControl()
        Me.BVBNew.Enabled = CType(TcodeCollection.Item("MByrN"), Boolean)
        Me.BVBEdit.Enabled = False
        Me.BVBDelete.Enabled = False
        Me.BVBExit.Enabled = True
        Me.BVTMetode_s.Enabled = True
        ...
        Me.SLUNoAcc.Properties.ReadOnly = True
    ...
    Private Sub OpenControl()
        ...
        Me.SLUNoAcc.Properties.ReadOnly = False
        ...
        Me.BVTMetode_e.Selected = True
    End Sub

    Public Sub LUE()
        Dim cmsl As SqlDataAdapter

        cmsl = New SqlDataAdapter("Select AccID,AN,BankID From M_BankAcc Where Aktif='True'", koneksi)
        cmsl.TableMappings.Add("Table", "M_BankAccLUE")
        cmsl.Fill(DsMaster, "M_BankAccLUE")
        DsMaster.Tables("M_BankAccLUE").Clear()
        cmsl.Fill(DsMaster, "M_BankAccLUE")

        Me.SLUNoAcc.Properties.DataSource = DsMaster.Tables("M_BankAccLUE")
        Me.SLUNoAcc.Properties.DisplayMember = "AccID"
        Me.SLUNoAcc.Properties.ValueMember = "AccID"
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select MetodeID,PeriodID,Tanggal,H.SuppID,S.Nama As Supp,Metode,AccID,TglJT,CurrID,MtUang,NilTukarRp,TotBayar, TotBayarRp,H.Ket,SisaPakai,stsPakai,H.InsDate,H.InsBy,H.UpdDate,H.UpdBy From T_MetodeByr H Inner Join M_Supp S On H.SuppID=S.SuppID Where PeriodID=" & MainModule.periodAktif & "", koneksi)

        cmsl.TableMappings.Add("Table", "T_MetodeByr")
        'DsMaster = New System.Data.DataSet
        cmsl.Fill(DsMaster, "T_MetodeByr")
        DsMaster.Tables("T_MetodeByr").Clear()
        cmsl.Fill(DsMaster, "T_MetodeByr")
    ...
    Private Sub FMetodeByr_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Metode Pembayaran Tagihan"
    End Sub

    Private Sub FMetodeByr_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        CekSave = False
    End Sub

    Private Sub FMetodeByr_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
        If BSave.Enabled = True Then
            Me.Focus()
        End If
    End Sub

    Private Sub FMetodeByr_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LockControl()
        Me.BVTMetode_e.Selected = True
    End Sub

    Private Sub BVTMetode_s_ItemPressed(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVTMetode_s.ItemPressed
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Search Metode Pembayaran Tagihan"
        FillDt()

        Me.BVBEdit.Enabled = CType(TcodeCollection.Item("MByrEd"), Boolean)
        Me.BVBDelete.Enabled = CType(TcodeCollection.Item("MByrDel"), Boolean)
    End Sub

    Private Sub BVBNew_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBNew.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Create Metode Pembayaran Tagihan"
        ...
        Me.CBOMetode.EditValue = ""
        Me.SLUNoAcc.EditValue = ""
    ...
    Private Sub BVBEdit_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBEdit.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Edit Metode Pembayaran Tagihan"
        ...
        If Me.GridView2.GetFocusedDataRow.Item("TotBayar") <> Me.GridView2.GetFocusedDataRow.Item("SisaPakai") Then
        ...
        Else
            ...
            Indicator = "200"
            Me.TBKode.EditValue = Me.GridView2.GetFocusedDataRow.Item("MetodeID")
            ...
            Me.SLUNoAcc.EditValue = Me.GridView2.GetFocusedDataRow.Item("AccID")
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        CType(Me.MdiParent, FUtama).BSIInfo.Caption = "Delete Metode Pembayaran Tagihan"
        ...
        Else
            If XtraMessageBox.Show("Apakah Anda Mau Menghapus Data : " & Me.GridView2.GetFocusedDataRow.Item("MetodeID") & " Ini ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim cmSP As New SqlCommand("SPDelT_MetodeByr")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer

                With cmSP
                    .Parameters.Add("@Kode", SqlDbType.VarChar).Value = Me.GridView2.GetFocusedDataRow.Item("MetodeID")
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Select Case Indicator
            Case 100
                Dim cmSP As New SqlCommand("SPInsT_MetodeByr")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
                ...
                With cmSP
                    ...
                    .Parameters.Add("@AccID", SqlDbType.VarChar).Value = Me.SLUNoAcc.EditValue
            ...
            Case 200
                Dim cmSP As New SqlCommand("SPUpT_MetodeByr")
                cmSP.CommandType = CommandType.StoredProcedure
                Dim x As Integer
