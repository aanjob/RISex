...
Public Class XRRPB
    ...
    Public Sub InitializeData(ByVal Bind As Collection, Gol As String)
        ...
        cmsl = New SqlDataAdapter("Select (Select BtNum + ', '  From (Select Distinct BtNum From T_RPBDtl Where BBID=D.BBID and RPBID=H.RPBID) as q order By BtNum FOR XML PATH('')) As BtNum,'('+ D.BBID +') ' + B.Nama as Bahan,D.Sat,Sum(Qty) As Qty,(Select Isnull ((Select Round(Sum(Keb), 0) From T_BOMDtl Where (BBID = D.BBID) And (BOMID = H.DocID)), 0) AS Expr1) AS QtyBOM From T_RPB H Inner Join T_RPBDtl D On H.RPBID=D.RPBID Inner Join M_BB B On D.BBID=B.BBID Where H.RPBID ='" & Bind.Item("Kode").ToString & "' Group By D.BBID,b.Nama,D.Sat,H.DocID,H.RPBID Order By B.Nama", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_RPBDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("BtNum", "BtNum"), New System.Data.Common.DataColumnMapping("Bahan", "Bahan"), New System.Data.Common.DataColumnMapping("Sat", "Sat"), New System.Data.Common.DataColumnMapping("QtyBOM", "QtyBOM"), New System.Data.Common.DataColumnMapping("Qty", "Qty")})})
        ...
        Me.LBQtyBOM.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_RPBDtl.QtyBOM")})
