...
Public Class FTransBB_dv1
    ...
    Public Sub FillDtl(Kode As String)
        ...
        cmsl = New SqlDataAdapter("Select TrIDD,TrID,'" & InisialBC & "'+D.BBIDAs As BBIDAs,Nama As BahanAs,D.SatAs,QtyAs,'" & InisialBC & "'+D.BBIDTj As BBIDTj,(Select Nama From M_BB Where BBID=D.BBIDTj) As BahanTj,D.SatTj,QtyTj,D.Ket From T_TrBBDtl D Inner Join M_BB B On D.BBIDAs=B.BBID Where TrID='" & Kode & "'", koneksi)
