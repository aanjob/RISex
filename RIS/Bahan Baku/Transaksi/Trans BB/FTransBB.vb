...
Public Class FTransBB
    ...
    Public Sub FillDtl(Kode As String)
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select TrIDD,TrID,'" & InisialBC & "'+D.BBIDAs as BBIDAs,BtNumAs,Nama As BahanAs,D.SatAs,QtyAs,'" & InisialBC & "'+D.BBIDTj as BBIDTj,BtNumTj,(Select Nama From M_BB Where BBID=D.BBIDTj) As BahanTj,D.SatTj,QtyTj,HarSat,HarAkhir,D.Ket From T_TrBBDtl D Inner Join M_BB B On D.BBIDAs=B.BBID Where TrID='" & Kode & "'", koneksi)
    ...
    Private Sub BVBDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVBDelete.ItemClick
        ...
        If Manual = False Then
            ...
            Dim i : For i = Me.GridView1.RowCount - 1 To 0 Step -1
                ...
                Dim command As New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(i, "BBIDAs") & "','" & Me.GridView2.GetFocusedDataRow.Item("GdID") & "','" & Me.GridView2.GetFocusedDataRow.Item("TrID") & "'," & Me.GridView1.GetRowCellValue(i, "TrIDD") & ",'" & Me.GridView1.GetRowCellValue(i, "BtNum") & "')", koneksi)
                        ...
                        Dim i : For i = 0 To GridView1.RowCount - 1
                            If Not IsDBNull(Me.GridView1.GetRowCellValue(i, "BBIDAs")) Then
                                ...
                                With cmSPDtl
                                    ...
                                    .Parameters.Add("@BtNumAs", SqlDbType.VarChar).Value = Me.GridView1.GetRowCellValue(i, "BtNumAs")
                                    ...
                                    .Parameters.Add("@BtNumTj", SqlDbType.VarChar).Value = Me.GridView1.GetRowCellValue(i, "BtNumTj")
    ...
    Private Sub BEdBBIDAs_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles BEdBBIDAs.ButtonClick
        ...
        If Not IsDBNull(dataTrans.Item("Kode").ToString) Then
            ...
            Me.GridView1.SetRowCellValue(Me.GridView1.FocusedRowHandle, "BtNumAs", dataTrans.Item("BtNum").ToString)
    ...
    Private Sub BEdBtNumTj_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles BEdBtNumTj.ButtonClick
        Try
            Dim frm As New FSearch("Batch Number", Me.GridView1.GetFocusedDataRow.Item("BBIDTj"), "", "", Date.Now, "")
            frm.ShowDialog()

            If Not IsDBNull(dataTrans.Item("BtNum").ToString) Then
                GridView1.ActiveEditor.EditValue = dataTrans.Item("BtNum").ToString
            End If
        Catch ex As Exception
    ...
    Private Sub BEdBtNumTj_KeyPress(sender As Object, e As KeyPressEventArgs) Handles BEdBtNumTj.KeyPress
        e.Handled = True
    End Sub
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        If e.Column Is GridView1.Columns("BBIDTj") Then
            If Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDTj") And Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumTj") Then
                XtraMessageBox.Show("Bahan Tidak Boleh Sama", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Me.GridView1.SetRowCellValue(e.RowHandle, "BBIDTj", "")
                Me.GridView1.SetRowCellValue(e.RowHandle, "BtNumTj", "")
        ...
        ElseIf e.Column Is GridView1.Columns("BtNumTj") Then
            If Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDTj") And Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumTj") Then
                XtraMessageBox.Show("Bahan Tidak Boleh Sama", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        ...
        ElseIf e.Column Is GridView1.Columns("QtyAs") Then
            ...
            command = New SqlCommand("Select dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumAs") & "')", koneksi)
            ...
            command2 = New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TrIDD") & ",'" & Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumAs") & "')", koneksi)
            ...
            Dim command3 As New SqlCommand("Select dbo.fcStokBBAll('" & Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TrIDD") & ")", koneksi)
            ...
            Dim i : For i = Me.GridView1.RowCount - 1 To 0 Step -1
                If Me.GridView1.GetRowCellValue(i, "BBIDAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDAs") And Me.GridView1.GetRowCellValue(i, "BtNumAs") = Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumAs") And Me.GridView1.GetRowCellValue(i, "TrIDD") & Me.GridView1.GetRowCellValue(i, "BBIDTj") <> Me.GridView1.GetRowCellValue(e.RowHandle, "TrIDD") & Me.GridView1.GetRowCellValue(e.RowHandle, "BBIDTj") Then
                    QtyAs += Me.GridView1.GetRowCellValue(i, "QtyAs")
                End If
            Next

            If Me.GridView1.GetRowCellValue(e.RowHandle, "TrIDD") < 0 Then
            ...
            If Me.GridView1.RowCount - 1 > 0 Then
                If Not IsDBNull(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBIDTj")) Then
                    If Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBIDTj") <> "" Then
                        ...
                        Dim commandx As New SqlCommand("Select dbo.fcStokBBBtNumAll('" & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BBIDTj") & "','" & Me.SLUGd.EditValue & "','" & Me.TBKode.EditValue & "'," & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TrIDD") & ",'" & Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "BtNumTj") & "')", koneksi)
    ...
    Private Sub GridView1_InitNewRow(sender As Object, e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView1.InitNewRow
        ...
        Me.GridView1.SetRowCellValue(e.RowHandle, "BtNumAs", "")
        Me.GridView1.SetRowCellValue(e.RowHandle, "BtNumTj", "")
    ...
    Private Sub GridView2_DoubleClick(sender As Object, e As EventArgs) Handles GridView2.DoubleClick
        Try
            Dim frm As New FTransBB_d(Me.GridView2.GetFocusedDataRow.Item("TrID"), Me.GridView2.GetFocusedDataRow.Item("GdID"), Manual)
            frm.ShowDialog()
            frm.Close()
        Catch ex As Exception
    ...
    Private Sub DTPTanggal_Leave(sender As Object, e As EventArgs) Handles DTPTanggal.Leave
        ...
        Dim i : For i = 0 To Me.GridView1.RowCount - 1
            ...
            Dim command As New SqlCommand("Select dbo.fcStokBB('" & Me.GridView1.GetRowCellValue(i, "BBIDAs") & "','" & Me.SLUGd.EditValue & "','" & Me.DTPTanggal.EditValue & "','" & Me.TBKode.EditValue & "','" & Me.GridView1.GetRowCellValue(i, "BtNumAs") & "')", koneksi)
            ...
            If Me.GridView1.GetRowCellValue(i, "QtyAs") > Stok Then
                XtraMessageBox.Show("Qty ID Bahan : " & Me.GridView1.GetRowCellValue(i, "BBIDAs") & " Melebihi Stok Bahan", "Peringatan",
    ...
    Private Sub GridView1_ValidateRow(sender As Object, e As DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs) Handles GridView1.ValidateRow
        Dim View As GridView = CType(sender, GridView)
        Dim BtNumCol As GridColumn = View.Columns("BtNumTj")

        If Me.GridView1.GetRowCellValue(e.RowHandle, "QtyTj") > 0 And Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumTj") = "" Then
            e.Valid = False
            View.SetColumnError(BtNumCol, "Batch Number Harus Diisi")

        ElseIf Me.GridView1.GetRowCellValue(e.RowHandle, "QtyTj") > 0 And Replace(Me.GridView1.GetRowCellValue(e.RowHandle, "BtNumTj"), " ", "") = "Rekal" Then
            e.Valid = False
