...
Public Class XRTransBBv1
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter

    Public Sub InitializeData(ByVal Bind As Collection)
        cmsl = New SqlDataAdapter("Select D.BBIDAs,Nama As BahanAs,D.SatAs,QtyAs,D.BBIDTj,(Select Nama From M_BB Where BBID=D.BBIDTj) As BahanTj,D.SatTj,QtyTj,D.Ket From T_TrBBDtl D Inner Join M_BB B On D.BBIDAs=B.BBID Where TrID='" & Bind.Item("Kode").ToString & "'", koneksi)

        cmsl.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "T_TrBBDtl", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("BahanAs", "BahanAs"), New System.Data.Common.DataColumnMapping("SatAs", "SatAs"), New System.Data.Common.DataColumnMapping("QtyAs", "QtyAs"), New System.Data.Common.DataColumnMapping("BahanTj", "BahanTj"), New System.Data.Common.DataColumnMapping("SatTj", "SatTj"), New System.Data.Common.DataColumnMapping("QtyTj", "QtyTj"), New System.Data.Common.DataColumnMapping("Ket", "Ket")})})
