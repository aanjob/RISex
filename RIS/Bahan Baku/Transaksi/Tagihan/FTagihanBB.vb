...
#End Region
    ...
    Public Sub FillDt()
        Dim cmsl As SqlDataAdapter
        cmsl = New SqlDataAdapter("Select TagihID,PeriodID,Jenis,Kat,Tanggal,TanggalFt,H.SuppID,S.Nama As Supplier,S.Alamat,K.Nama As Kota, CurrID, MtUang,NilTukarRp,TipePPn,PersenPPn,PEN,TglPEN,BL,TglBL,LC,TotQty,TotSbDisc,DiscP,RpDiscP,DiscRp,TotDisc,TotDPP,TotPPn,TotAkhir, TotAkhirRp,TotBM,TotCIF,SisaBayar,H.Ket,H.stsNonPT,stsLunas,H.InsDate,H.InsBy,H.UpdDate,H.UpdBy From T_Tagihan H Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Where PeriodID=" & MainModule.periodAktif & " Order By Tanggal,TagihID asc", koneksi)
    ...
    Private Sub BVTAProses_ItemPressed(sender As Object, e As DevExpress.XtraBars.Ribbon.BackstageViewItemEventArgs) Handles BVTAProses.ItemPressed
        ...
        Try
            DsMaster.Tables("Supp").Clear()
        Catch ex As Exception

        End Try

        Me.GridView8.ActiveFilter.Clear()

        Me.RBPPnA.EditValue = "Non PPn"
        Me.TBPersenPPnA.EditValue = 0
        ...
        Me.SLUMtUangA.Properties.DataSource = DsMaster.Tables("M_CurrLUE")
    ...
    Private Sub BProsesA_Click(sender As Object, e As EventArgs) Handles BProsesA.Click
        ...
        If Me.CBOKatA.EditValue <> "Barang Jadi" Then
            cmsl = New SqlDataAdapter("Select Distinct H.SuppID,convert(bit,'FALSE') as Cek,S.Nama,K.Nama As Kota From T_TrmBB H Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Inner Join T_POBB P On H.POID=P.POID Where H.MtUang ='" & Me.SLUMtUangA.EditValue & "' and H.Gol='" & Me.CBOGolA.EditValue & "' and H.Jenis='" & Me.CBOJnsA.EditValue & "' and H.TipePPn='" & Me.RBPPnA.EditValue & "' and H.PersenPPn=" & Me.TBPersenPPnA.EditValue & " and P.Kat='" & Me.CBOKatA.EditValue & "' and H.Tanggal >='" & Me.DTPAwalA.EditValue & "' and H.Tanggal <='" & Me.DTPAkhirA.EditValue & "' and stsTagih='False' and H.stsNonPT='" & Me.CENonPTA.EditValue & "'", koneksi)
            ...
            End Try
            cmsl.Fill(DsMaster, "Supp")
        Else
            cmsl = New SqlDataAdapter("Select Distinct H.SuppID,convert(bit,'FALSE') as Cek,S.Nama,K.Nama As Kota From T_TrmBJ H Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Where H.MtUang ='" & Me.SLUMtUangA.EditValue & "' and H.TipePPn='" & Me.RBPPnA.EditValue & "' and H.PersenPPn=" & Me.TBPersenPPnA.EditValue & " and H.JnsDoc='PO' and H.Tanggal >='" & Me.DTPAwalA.EditValue & "' and H.Tanggal <='" & Me.DTPAkhirA.EditValue & "' and stsTagih='False'", koneksi)
        ...
        Me.GridControl7.DataMember = "Supp"
    End Sub

    Private Sub BSaveA_Click(sender As Object, e As EventArgs) Handles BSaveA.Click
        koneksi.Close()
        Me.GridView8.ActiveFilterString = "[Cek] = True"

        Dim x As Integer
        Dim stsPPnA As Boolean

        If Me.RBPPnA.EditValue <> "Non PPn" Then
            stsPPnA = True
        Else
            stsPPnA = False
        End If
        ...
        If Me.CBOKatA.EditValue <> "Barang Jadi" Then
            Dim i : For i = 0 To Me.GridView8.RowCount - 1
                If Me.GridView8.GetRowCellValue(i, "Cek") = True Then
                    Dim cmSP As New SqlCommand("SPProsessT_TagihanBB")
                    cmSP.CommandType = CommandType.StoredProcedure

                    With cmSP
                        .Parameters.Add("@Manual", SqlDbType.Bit).Value = False
                        .Parameters.Add("@MnlInsUpd", SqlDbType.Bit).Value = False
                        ...
                        .Parameters.Add("@SuppID", SqlDbType.VarChar).Value = Me.GridView8.GetRowCellValue(i, "SuppID")
                        .Parameters.Add("@MtUang", SqlDbType.VarChar).Value = Me.SLUMtUangA.EditValue
                        .Parameters.Add("@TipePPn", SqlDbType.VarChar).Value = Me.RBPPnA.EditValue
                        .Parameters.Add("@PersenPPn", SqlDbType.Decimal).Value = Me.TBPersenPPnA.EditValue
                        .Parameters.Add("@Jenis", SqlDbType.VarChar).Value = Me.CBOJnsA.EditValue
                        .Parameters.Add("@Kat", SqlDbType.VarChar).Value = Me.CBOKatA.EditValue
                        .Parameters.Add("@Gol", SqlDbType.VarChar).Value = Me.CBOGolA.EditValue
                        .Parameters.Add("@stsNonPT", SqlDbType.Bit).Value = Me.CENonPTA.EditValue
                        .Parameters.Add("@PPn", SqlDbType.VarChar).Value = stsPPnA
        ...
        Else
            ...
            Dim i : For i = 0 To Me.GridView8.RowCount - 1
                If Me.GridView8.GetRowCellValue(i, "Cek") = True Then
                    Dim cmSP As New SqlCommand("SPProsessT_TagihanBJ")
                    cmSP.CommandType = CommandType.StoredProcedure
    ...
    Private Sub GridView8_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView8.DoubleClick
        If CekAll Then
            CekAll = False
            For i As Integer = 0 To Me.GridView8.RowCount - 1
                Me.GridView8.SetRowCellValue(i, "Cek", 0)
            Next
        Else
            CekAll = True
            For i As Integer = 0 To Me.GridView8.RowCount - 1
                Me.GridView8.SetRowCellValue(i, "Cek", 1)
            Next
        End If
    End Sub
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Dim cmd2 As New SqlCommand("SPAftSTagih")
    ...
    Private Sub BEdTrmID_ButtonClick(sender As Object, e As Controls.ButtonPressedEventArgs) Handles BEdTrmID.ButtonClick
        Try
            ...
            Dim frm As New FSearch("LPB", Me.SLUSupp.EditValue, Me.RBPPn.EditValue, Me.SLUMtUang.EditValue, Me.DTPTanggal.EditValue, Me.TBPersenPPn.EditValue)
            frm.ShowDialog()
    ...
    Private Sub BEdTrmBJID_ButtonClick(sender As Object, e As Controls.ButtonPressedEventArgs) Handles BEdTrmBJID.ButtonClick
        Try
            ...
            Dim frm As New FSearch("LPB BJ", Me.SLUSupp.EditValue, Me.RBPPn.EditValue, Me.SLUMtUang.EditValue, Me.DTPTanggal.EditValue, "")
            frm.ShowDialog()
