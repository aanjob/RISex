...
#End Region
    ...
    Private Sub BProsesA_Click(sender As Object, e As EventArgs) Handles BProsesA.Click
        ...
        If Me.CBOKatA.EditValue <> "Barang Jadi" Then
            cmsl = New SqlDataAdapter("Select Distinct H.SuppID,convert(bit,'FALSE') as Cek,S.Nama,K.Nama As Kota From T_TrmBB H Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Inner Join T_POBB P On H.POID=P.POID Where H.MtUang ='" & Me.SLUMtUangA.EditValue & "' and H.Gol='" & Me.CBOGolA.EditValue & "' and H.Jenis='" & Me.CBOJnsA.EditValue & "' and H.TipePPn='" & Me.RBPPnA.EditValue & "' and P.Kat='" & Me.CBOKatA.EditValue & "' and H.Tanggal >='" & Me.DTPAwalA.EditValue & "' and H.Tanggal <='" & Me.DTPAkhirA.EditValue & "' and stsTagih='False'", koneksi)
        ...
        Else
            cmsl = New SqlDataAdapter("Select Distinct H.SuppID,convert(bit,'FALSE') as Cek,S.Nama,K.Nama As Kota From T_TrmBJ H Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_Kota K On S.KotaID=K.KotaID Where H.MtUang ='" & Me.SLUMtUangA.EditValue & "' and H.TipePPn='" & Me.RBPPnA.EditValue & "' and H.JnsDoc='PO' and H.Tanggal >='" & Me.DTPAwalA.EditValue & "' and H.Tanggal <='" & Me.DTPAkhirA.EditValue & "' and stsTagih='False'", koneksi)
    ...
    Private Sub BEdTrmID_ButtonClick(sender As Object, e As Controls.ButtonPressedEventArgs) Handles BEdTrmID.ButtonClick
        Try
            ...
            Dim frm As New FSearch("LPB", Me.SLUSupp.EditValue, Me.RBPPn.EditValue, Me.SLUMtUang.EditValue, Me.DTPTanggal.EditValue, "")
            frm.ShowDialog()
