...
Public Class XRScPOK
    Dim koneksi As New SqlConnection(GlobalKoneksi)
    Dim cmsl As SqlDataAdapter

    Public Sub InitializeData()
        cmsl = New SqlDataAdapter("Select H.POID,H.Tanggal,S.Nama As Supp,H.CustID,C.Nama As Cust,BOMID,B.Nama As Bahan,D.Sat,Qty,Ready,ETD,ETA From T_POBB H Inner Join T_POBBDtl D On H.POID=D.POID Inner Join M_Cust C On H.CustID=C.CustID Inner Join M_Supp S On H.SuppID=S.SuppID Inner Join M_BB B On D.BBID=B.BBID Where H.stsKirim=0 Order By Ready,H.POID,B.Nama Asc", koneksi)
