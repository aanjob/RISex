...
Public Class XRScPOCust
    ...
    Public Sub InitializeData()
       ...
       Me.LBUser.Text = MainModule.LoginAktif
        ...
        Me.LBSisa.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "T_POBBDtl.SisaKirim", "{0:#,##0.##}")})
